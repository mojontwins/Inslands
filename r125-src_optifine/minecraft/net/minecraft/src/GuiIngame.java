...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float f1, boolean z2, int i3, int i4) {
		...
		if(this.mc.gameSettings.showDebugInfo) {
			...
			if(this.mc.theWorld != null && this.mc.theWorld.blockExists(i45, i22, i23)) {
				...
				this.drawString(fontRenderer8, "lc: " + (chunk48.getTopFilledSegment() + 15) + " b: " + chunk48.func_48490_a(i45 & 15, i23 & 15, this.mc.theWorld.getWorldChunkManager()).biomeName + " bl: " + chunk48.getSavedLightValue(EnumSkyBlock.Block, i45 & 15, i22, i23 & 15) + " sl: " + chunk48.getSavedLightValue(EnumSkyBlock.Sky, i45 & 15, i22, i23 & 15) + " rl: " + chunk48.getBlockLightValue(i45 & 15, i22, i23 & 15, 0), 2, 96, 14737632);
			}
		...
		if(this.mc.thePlayer instanceof EntityClientPlayerMP && this.mc.gameSettings.keyBindPlayerList.pressed) {
			...
			List list38 = netClientHandler37.playerNames;
	...
	private void func_50010_a(FontRenderer fontRenderer1) {
		...
		if(i5 > 0) {
			...
			int i6;
			int i10;
			for(i6 = 0; i6 + this.field_50017_n < this.chatMessageList.size() && i6 < b2; ++i6) {
				if(((ChatLine)this.chatMessageList.get(i6)).updateCounter < 200 || z3) {
					ChatLine chatLine7 = (ChatLine)this.chatMessageList.get(i6 + this.field_50017_n);
	...
	private void renderBossHealth() {
		if(RenderDragon.entityDragon != null) {
			...
			short s5 = 182;
			int i6 = i4 / 2 - s5 / 2;
			int i7 = (int)((float)entityDragon1.func_41010_ax() / (float)entityDragon1.getMaxHealth() * (float)(s5 + 1));
			byte b8 = 12;
	...
	public void addChatMessage(String string1) {
		...
		boolean z3 = true;
		Iterator iterator4 = this.mc.fontRenderer.func_50108_c(string1, 320).iterator();
	...
	public void func_50011_a(int i1) {
		...
		if(!this.isChatOpen()) {
			...
			if(i1 >= 0 && i2 >= 0) {
				...
				if(i1 <= 320 && i2 < this.mc.fontRenderer.FONT_HEIGHT * i4 + i4) {
					...
					return new ChatClickData(this.mc.fontRenderer, (ChatLine)this.chatMessageList.get(i5), i1, i2 - (i5 - this.field_50017_n) * this.mc.fontRenderer.FONT_HEIGHT + i5);
				} else {
					return null;
				}
			} else {
