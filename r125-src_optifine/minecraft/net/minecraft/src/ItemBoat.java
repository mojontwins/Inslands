...
public class ItemBoat extends Item {
	...
	public ItemStack onItemRightClick(ItemStack itemStack1, World world2, EntityPlayer entityPlayer3) {
		...
		if(movingObjectPosition24 == null) {
			...
			boolean z26 = false;
			float f27 = 1.0F;
			List list28 = world2.getEntitiesWithinAABBExcludingEntity(entityPlayer3, entityPlayer3.boundingBox.addCoord(vec3D25.xCoord * d21, vec3D25.yCoord * d21, vec3D25.zCoord * d21).expand((double)f27, (double)f27, (double)f27));
