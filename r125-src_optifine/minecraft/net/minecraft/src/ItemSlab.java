	...
	public boolean onItemUse(ItemStack itemStack1, EntityPlayer entityPlayer2, World world3, int i4, int i5, int i6, int i7) {
		if(itemStack1.stackSize == 0) {
			...
			if((i7 == 1 && !z11 || i7 == 0 && z11) && i8 == Block.stairSingle.blockID && i10 == itemStack1.getItemDamage()) {
				...
				return func_50087_b(itemStack1, entityPlayer2, world3, i4, i5, i6, i7) ? true : super.onItemUse(itemStack1, entityPlayer2, world3, i4, i5, i6, i7);
			}
		}
	}

	private static boolean func_50087_b(ItemStack itemStack0, EntityPlayer entityPlayer1, World world2, int i3, int i4, int i5, int i6) {
		if(i6 == 0) {
			--i4;
		}
