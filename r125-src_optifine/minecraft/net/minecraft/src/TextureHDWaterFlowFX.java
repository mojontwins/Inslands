...
public class TextureHDWaterFlowFX extends TextureFX implements TextureHDFX {
	...
	public void onTick() {
		...
		if(this.imageData != null) {
			...
			for(int i15 = 0; i15 < this.tileWidth * this.tileWidth; ++i15) {
				float f16 = this.buf1[i15 - this.tickCounter * this.tileWidth & widthMask2];
				if(f16 > 1.0F) {
					f16 = 1.0F;
				}
				...
				float f17 = f16 * f16;
				r = (int)(32.0F + f17 * 32.0F);
				int g = (int)(50.0F + f17 * 64.0F);
				int b = 255;
				int a = (int)(146.0F + f17 * 50.0F);
				...
				this.imageData[i15 * 4 + 0] = (byte)r;
				this.imageData[i15 * 4 + 1] = (byte)g;
				this.imageData[i15 * 4 + 2] = (byte)b;
				this.imageData[i15 * 4 + 3] = (byte)a;
			}
