...
public class BlockBrewingStand extends BlockContainer {
	...
	public void randomDisplayTick(World world1, int i2, int i3, int i4, Random random5) {
		double d6 = (double)((float)i2 + 0.4F + random5.nextFloat() * 0.2F);
		double d8 = (double)((float)i3 + 0.7F + random5.nextFloat() * 0.3F);
		double d10 = (double)((float)i4 + 0.4F + random5.nextFloat() * 0.2F);
