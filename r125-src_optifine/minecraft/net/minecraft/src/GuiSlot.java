...
public abstract class GuiSlot {
	...
	public void drawScreen(int i1, int i2, float f3) {
			...
			if(this.initialClickY == -1.0F) {
				...
				if(i2 >= this.top && i2 <= this.bottom) {
					...
					if(i1 >= i5 && i1 <= i6) {
						...
						i20 = this.getContentHeight() - (this.bottom - this.top - 4);
						if(i20 < 1) {
							i20 = 1;
						}
		...
		tessellator18.setColorOpaque_I(2105376);
		...
		for(i11 = 0; i11 < i4; ++i11) {
			...
			if(i20 <= this.bottom && i20 + i13 >= this.top) {
				if(this.field_25123_p && this.isSelected(i11)) {
					...
					tessellator18.startDrawingQuads();
					tessellator18.setColorOpaque_I(8421504);
					...
					tessellator18.setColorOpaque_I(0);
