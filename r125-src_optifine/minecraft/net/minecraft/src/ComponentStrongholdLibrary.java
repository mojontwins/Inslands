...
public class ComponentStrongholdLibrary extends ComponentStronghold {
	...
	public static ComponentStrongholdLibrary findValidPlacement(List list0, Random random1, int i2, int i3, int i4, int i5, int i6) {
	...
	public boolean addComponentParts(World world1, Random random2, StructureBoundingBox structureBoundingBox3) {
		if(this.isLiquidInStructureBoundingBox(world1, structureBoundingBox3)) {
			...
			this.createTreasureChestAtCurrentPosition(world1, structureBoundingBox3, random2, 3, 3, 5, field_35056_b, 1 + random2.nextInt(4));
			if(this.isLargeRoom) {
				this.placeBlockAtCurrentPosition(world1, 0, 0, 12, 9, 1, structureBoundingBox3);
				this.createTreasureChestAtCurrentPosition(world1, structureBoundingBox3, random2, 12, 8, 1, field_35056_b, 1 + random2.nextInt(4));
			}
