...
public class BlockPistonBase extends Block {
	...
	private void updatePistonState(World world1, int i2, int i3, int i4) {
		...
		boolean z7 = this.isIndirectlyPowered(world1, i2, i3, i4, i6);
		if(i5 != 7) {
			if(z7 && !isExtended(i5)) {
	...
	private boolean isIndirectlyPowered(World world1, int i2, int i3, int i4, int i5) {
			...
			if(this.isSticky) {
				...
				if(i12 == Block.pistonMoving.blockID) {
					...
					if(tileEntity15 != null && tileEntity15 instanceof TileEntityPiston) {
						...
						if(tileEntityPiston16.getPistonOrientation() == i6 && tileEntityPiston16.isExtending()) {
	...
	private static boolean canPushBlock(int i0, World world1, int i2, int i3, int i4, boolean z5) {
		if(i0 == Block.obsidian.blockID) {
			...
			return !(Block.blocksList[i0] instanceof BlockContainer);
		}
	}
