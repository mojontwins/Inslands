...
public class Packet24MobSpawn extends Packet {
	...
	public Packet24MobSpawn(EntityLiving entityLiving1) {
		...
		this.field_48113_h = (byte)((int)(entityLiving1.rotationYawHead * 256.0F / 360.0F));
	...
	public void readPacketData(DataInputStream dataInputStream1) throws IOException {
		...
		this.field_48113_h = dataInputStream1.readByte();
	...
	public void writePacketData(DataOutputStream dataOutputStream1) throws IOException {
		...
		dataOutputStream1.writeByte(this.field_48113_h);
