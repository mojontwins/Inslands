...
public class GuiStatsComponent extends JComponent {
	...
	public GuiStatsComponent(MinecraftServer minecraftServer1) {
		this.field_40572_e = minecraftServer1;
	...
	private void updateStats() {
		...
		if(this.field_40572_e.worldMngr != null) {
			for(int i3 = 0; i3 < this.field_40572_e.worldMngr.length; ++i3) {
				this.displayStrings[5 + i3] = "Lvl " + i3 + " tick: " + field_40573_a.format(this.func_48551_a(this.field_40572_e.field_40028_g[i3]) * 1.0E-6D) + " ms";
				if(this.field_40572_e.worldMngr[i3] != null && this.field_40572_e.worldMngr[i3].chunkProviderServer != null) {
					this.displayStrings[5 + i3] = this.displayStrings[5 + i3] + ", " + this.field_40572_e.worldMngr[i3].chunkProviderServer.func_46040_d();
				}
			}
		}
	...
	private double func_48551_a(long[] j1) {
		long j2 = 0L;
