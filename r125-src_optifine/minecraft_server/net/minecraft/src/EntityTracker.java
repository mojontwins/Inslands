...
public class EntityTracker {
	...
	public void trackEntity(Entity entity1) {
		if(entity1 instanceof EntityPlayerMP) {
		...
		} else if(entity1 instanceof EntityEnderPearl) {
			this.trackEntity(entity1, 64, 10, true);
		} else if(entity1 instanceof EntityEnderEye) {
			this.trackEntity(entity1, 64, 10, true);
		} else if(entity1 instanceof EntityEgg) {
			this.trackEntity(entity1, 64, 10, true);
		} else if(entity1 instanceof EntityPotion) {
			this.trackEntity(entity1, 64, 10, true);
		} else if(entity1 instanceof EntityExpBottle) {
			this.trackEntity(entity1, 64, 10, true);
			...
			this.trackEntity(entity1, 80, 3, true);
		} else if(entity1 instanceof EntityDragon) {
		...
		} else if(entity1 instanceof EntityXPOrb) {
			this.trackEntity(entity1, 160, 20, true);
		} else if(entity1 instanceof EntityEnderCrystal) {
			this.trackEntity(entity1, 256, Integer.MAX_VALUE, false);
		}
