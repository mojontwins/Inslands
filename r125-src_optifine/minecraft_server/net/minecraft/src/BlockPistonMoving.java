...
public class BlockPistonMoving extends BlockContainer {
	...
	public void dropBlockAsItemWithChance(World world1, int i2, int i3, int i4, int i5, float f6, int i7) {
		if(!world1.isRemote) {
			...
			if(tileEntityPiston8 != null) {
				Block.blocksList[tileEntityPiston8.getStoredBlockID()].dropBlockAsItem(world1, i2, i3, i4, tileEntityPiston8.getBlockMetadata(), 0);
			}
		}
	}
	...
	public AxisAlignedBB getCollisionBoundingBoxFromPool(World world1, int i2, int i3, int i4) {
		...
		if(tileEntityPiston5 == null) {
			...
			if(tileEntityPiston5.isExtending()) {
				f6 = 1.0F - f6;
			}

			return this.getAxisAlignedBB(world1, i2, i3, i4, tileEntityPiston5.getStoredBlockID(), f6, tileEntityPiston5.getPistonOrientation());
		}
	}
	...
	public void setBlockBoundsBasedOnState(IBlockAccess iBlockAccess1, int i2, int i3, int i4) {
		...
		if(tileEntityPiston5 != null) {
			...
			int i8 = tileEntityPiston5.getPistonOrientation();
	...
	public AxisAlignedBB getAxisAlignedBB(World world1, int i2, int i3, int i4, int i5, float f6, int i7) {
