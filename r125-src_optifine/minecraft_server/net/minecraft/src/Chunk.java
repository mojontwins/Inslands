...
public class Chunk {
					...
					do {
						...
						if(i4 > 0) {
							...
							if(extendedBlockStorage6 != null) {
								...
								this.worldObj.func_48086_o((this.xPosition << 4) + i2, i5, (this.zPosition << 4) + i3);
							}
						}
				...
				if(i5 < i4) {
					for(i8 = i5; i8 < i4; ++i8) {
						...
						if(extendedBlockStorage9 != null) {
							...
							this.worldObj.func_48086_o((this.xPosition << 4) + i1, i8, (this.zPosition << 4) + i3);
						}
					}
				} else {
					for(i8 = i4; i8 < i5; ++i8) {
	...
	public void removeUnknownBlocks() {
		...
		for(int i3 = 0; i3 < i2; ++i3) {
			...
			if(extendedBlockStorage4 != null) {
				extendedBlockStorage4.func_48603_e();
			}
		}
	...
	public BiomeGenBase func_48560_a(int i1, int i2, WorldChunkManager worldChunkManager3) {
