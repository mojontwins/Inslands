...
public class SlotFurnace extends Slot {
	...
	public ItemStack decrStackSize(int i1) {
		if(this.getHasStack()) {
			this.field_48419_f += Math.min(i1, this.getStack().stackSize);
		}
	...
	protected void func_48415_a(ItemStack itemStack1, int i2) {
		this.field_48419_f += i2;
		this.func_48416_b(itemStack1);
	}

	protected void func_48416_b(ItemStack itemStack1) {
		itemStack1.onCrafting(this.thePlayer.worldObj, this.thePlayer, this.field_48419_f);
