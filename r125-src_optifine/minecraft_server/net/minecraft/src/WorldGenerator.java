...
public abstract class WorldGenerator {
	...
	protected void func_50023_a(World world1, int i2, int i3, int i4, int i5) {
	...
	protected void setBlockAndMetadata(World world1, int i2, int i3, int i4, int i5, int i6) {
		...
		} else if(world1.blockExists(i2, i3, i4) && world1.getChunkFromBlockCoords(i2, i4).field_50025_o) {
