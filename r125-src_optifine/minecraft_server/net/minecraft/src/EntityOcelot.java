...
public class EntityOcelot extends EntityTameable {
	...
	public void writeEntityToNBT(NBTTagCompound nBTTagCompound1) {
		...
		nBTTagCompound1.setInteger("CatType", this.func_48375_r());
	}

	public void readEntityFromNBT(NBTTagCompound nBTTagCompound1) {
		super.readEntityFromNBT(nBTTagCompound1);
		this.func_48376_c_(nBTTagCompound1.getInteger("CatType"));
	}
	...
	public boolean interact(EntityPlayer entityPlayer1) {
		...
		if(!this.isTamed()) {
			if(this.aiTempt.func_48261_f() && itemStack2 != null && itemStack2.itemID == Item.fishRaw.shiftedIndex && entityPlayer1.getDistanceSqToEntity(this) < 9.0D) {
			...
			if(entityPlayer1.username.equalsIgnoreCase(this.getOwnerName()) && !this.worldObj.isRemote && !this.isWheat(itemStack2)) {
				this.aiSit.func_48210_a(!this.isSitting());
			}
	...
	public EntityAnimal spawnBabyAnimal(EntityAnimal entityAnimal1) {
		...
		if(this.isTamed()) {
			...
			entityOcelot2.func_48376_c_(this.func_48375_r());
		}
	...
	public boolean func_48362_b(EntityAnimal entityAnimal1) {
	...
	public void func_48376_c_(int i1) {
