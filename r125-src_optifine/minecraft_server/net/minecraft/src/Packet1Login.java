...
public class Packet1Login extends Packet {
	...
	public void readPacketData(DataInputStream dataInputStream1) throws IOException {
		...
		this.field_48112_e = dataInputStream1.readInt();
	...
	public void writePacketData(DataOutputStream dataOutputStream1) throws IOException {
		...
		if(this.terrainType == null) {
			...
			writeString(this.terrainType.func_48449_a(), dataOutputStream1);
		}

		dataOutputStream1.writeInt(this.serverMode);
		dataOutputStream1.writeInt(this.field_48112_e);
	...
	public int getPacketSize() {
		int i1 = 0;
		if(this.terrainType != null) {
			i1 = this.terrainType.func_48449_a().length();
		}
