	...
	public void onUpdate() {
		...
		if(this.numBlocksToUpdate != 0) {
			...
			if(this.numBlocksToUpdate == 1) {
				...
				if(worldServer1.func_48084_h(i2, i3, i4)) {
				...
				if(this.numBlocksToUpdate == 64) {
					i2 = this.chunkX * 16;
					i3 = this.chunkZ * 16;
					this.sendPacketToPlayersInInstance(new Packet51MapChunk(worldServer1.getChunkFromChunkCoords(this.chunkX, this.chunkZ), false, this.field_48475_h));

					for(i4 = 0; i4 < 16; ++i4) {
						if((this.field_48475_h & 1 << i4) != 0) {
							i5 = i4 << 4;
					...
					for(i2 = 0; i2 < this.numBlocksToUpdate; ++i2) {
						...
						if(worldServer1.func_48084_h(i3, i4, i5)) {
