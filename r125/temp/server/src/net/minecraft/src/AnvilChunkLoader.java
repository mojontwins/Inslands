...
public class AnvilChunkLoader implements IChunkLoader, IThreadedFileIO {
	...
	private Set field_48467_b = new HashSet();
	private Object field_48468_c = new Object();
	...
	public Chunk loadChunk(World world1, int i2, int i3) throws IOException {
		...
		Object object6 = this.field_48468_c;
		synchronized(this.field_48468_c) {
			if(this.field_48467_b.contains(chunkCoordIntPair5)) {
				for(int i7 = 0; i7 < this.field_48469_a.size(); ++i7) {
					if(((AnvilChunkLoaderPending)this.field_48469_a.get(i7)).field_48581_a.equals(chunkCoordIntPair5)) {
						nBTTagCompound4 = ((AnvilChunkLoaderPending)this.field_48469_a.get(i7)).field_48580_b;
						break;
					}
				}
			}
		...
		return this.func_48464_a(world1, i2, i3, nBTTagCompound4);
	}

	protected Chunk func_48464_a(World world1, int i2, int i3, NBTTagCompound nBTTagCompound4) {
		if(!nBTTagCompound4.hasKey("Level")) {
			...
			Chunk chunk5 = this.func_48465_a(world1, nBTTagCompound4.getCompoundTag("Level"));
			if(!chunk5.isAtLocation(i2, i3)) {
				...
				chunk5 = this.func_48465_a(world1, nBTTagCompound4.getCompoundTag("Level"));
			}
	...
	public void saveChunk(World world1, Chunk chunk2) {
		...
		try {
			...
			this.func_48462_a(chunk2, world1, nBTTagCompound4);
			this.func_48463_a(chunk2.getChunkCoordIntPair(), nBTTagCompound3);
	...
	protected void func_48463_a(ChunkCoordIntPair chunkCoordIntPair1, NBTTagCompound nBTTagCompound2) {
		Object object3 = this.field_48468_c;
		synchronized(this.field_48468_c) {
			if(this.field_48467_b.contains(chunkCoordIntPair1)) {
				for(int i4 = 0; i4 < this.field_48469_a.size(); ++i4) {
					if(((AnvilChunkLoaderPending)this.field_48469_a.get(i4)).field_48581_a.equals(chunkCoordIntPair1)) {
						this.field_48469_a.set(i4, new AnvilChunkLoaderPending(chunkCoordIntPair1, nBTTagCompound2));
						return;
					}
				}
			}

			this.field_48469_a.add(new AnvilChunkLoaderPending(chunkCoordIntPair1, nBTTagCompound2));
			this.field_48467_b.add(chunkCoordIntPair1);
	...
	public boolean writeNextIO() {
		...
		Object object2 = this.field_48468_c;
		synchronized(this.field_48468_c) {
			if(this.field_48469_a.size() <= 0) {
				return false;
			}

			anvilChunkLoaderPending1 = (AnvilChunkLoaderPending)this.field_48469_a.remove(0);
			this.field_48467_b.remove(anvilChunkLoaderPending1.field_48581_a);
		}

		if(anvilChunkLoaderPending1 != null) {
			try {
				this.func_48461_a(anvilChunkLoaderPending1);
	...
	private void func_48461_a(AnvilChunkLoaderPending anvilChunkLoaderPending1) throws IOException {
		DataOutputStream dataOutputStream2 = RegionFileCache.getChunkOutputStream(this.chunkSaveLocation, anvilChunkLoaderPending1.field_48581_a.chunkXPos, anvilChunkLoaderPending1.field_48581_a.chunkZPos);
		CompressedStreamTools.write(anvilChunkLoaderPending1.field_48580_b, dataOutputStream2);
	...
	private void func_48462_a(Chunk chunk1, World world2, NBTTagCompound nBTTagCompound3) {
		...
		nBTTagCompound3.func_48446_a("HeightMap", chunk1.heightMap);
		...
		for(int i8 = 0; i8 < i7; ++i8) {
			...
			if(extendedBlockStorage9 != null && extendedBlockStorage9.func_48587_f() != 0) {
				nBTTagCompound10 = new NBTTagCompound();
				nBTTagCompound10.setByte("Y", (byte)(extendedBlockStorage9.getYLocation() >> 4 & 255));
				nBTTagCompound10.setByteArray("Blocks", extendedBlockStorage9.func_48590_g());
				...
				nBTTagCompound10.setByteArray("Data", extendedBlockStorage9.func_48594_i().data);
		...
		iterator17 = chunk1.chunkTileEntityMap.values().iterator();
		...
		List list18 = world2.getPendingBlockUpdates(chunk1, false);
		if(list18 != null) {
			long j21 = world2.getWorldTime();
			NBTTagList nBTTagList11 = new NBTTagList();
			Iterator iterator12 = list18.iterator();
	...
	private Chunk func_48465_a(World world1, NBTTagCompound nBTTagCompound2) {
		int i3 = nBTTagCompound2.getInteger("xPos");
		int i4 = nBTTagCompound2.getInteger("zPos");
		Chunk chunk5 = new Chunk(world1, i3, i4);
		chunk5.heightMap = nBTTagCompound2.func_48445_l("HeightMap");
		...
		for(int i9 = 0; i9 < nBTTagList6.tagCount(); ++i9) {
			...
			extendedBlockStorage12.func_48599_d();
