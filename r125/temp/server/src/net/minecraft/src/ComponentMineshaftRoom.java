...
public class ComponentMineshaftRoom extends StructureComponent {
	...
	public ComponentMineshaftRoom(int i1, Random random2, int i3, int i4) {
		super(i1);
		this.boundingBox = new StructureBoundingBox(i3, 50, i4, i3 + 7 + random2.nextInt(6), 54 + random2.nextInt(6), i4 + 7 + random2.nextInt(6));
	}
	...
	public void buildComponent(StructureComponent structureComponent1, List list2, Random random3) {
		...
		for(i5 = 0; i5 < this.boundingBox.getXSize(); i5 += 4) {
			...
			structureComponent7 = StructureMineshaftPieces.getNextComponent(structureComponent1, list2, random3, this.boundingBox.minX + i5, this.boundingBox.minY + random3.nextInt(i6) + 1, this.boundingBox.minZ - 1, 2, i4);
		...
		for(i5 = 0; i5 < this.boundingBox.getXSize(); i5 += 4) {
			...
			structureComponent7 = StructureMineshaftPieces.getNextComponent(structureComponent1, list2, random3, this.boundingBox.minX + i5, this.boundingBox.minY + random3.nextInt(i6) + 1, this.boundingBox.maxZ + 1, 0, i4);
			if(structureComponent7 != null) {
				structureBoundingBox8 = structureComponent7.getBoundingBox();
		...
		for(i5 = 0; i5 < this.boundingBox.getZSize(); i5 += 4) {
			...
			structureComponent7 = StructureMineshaftPieces.getNextComponent(structureComponent1, list2, random3, this.boundingBox.minX - 1, this.boundingBox.minY + random3.nextInt(i6) + 1, this.boundingBox.minZ + i5, 1, i4);
			if(structureComponent7 != null) {
				structureBoundingBox8 = structureComponent7.getBoundingBox();
		...
		for(i5 = 0; i5 < this.boundingBox.getZSize(); i5 += 4) {
			...
			structureComponent7 = StructureMineshaftPieces.getNextComponent(structureComponent1, list2, random3, this.boundingBox.maxX + 1, this.boundingBox.minY + random3.nextInt(i6) + 1, this.boundingBox.minZ + i5, 3, i4);
			if(structureComponent7 != null) {
				structureBoundingBox8 = structureComponent7.getBoundingBox();
	...
	public boolean addComponentParts(World world1, Random random2, StructureBoundingBox structureBoundingBox3) {
		if(this.isLiquidInStructureBoundingBox(world1, structureBoundingBox3)) {
			...
			Iterator iterator4 = this.chidStructures.iterator();
