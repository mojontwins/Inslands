...
public class EntitySkeleton extends EntityMob {
	...
	public void onDeath(DamageSource damageSource1) {
		...
		if(damageSource1.getSourceOfDamage() instanceof EntityArrow && damageSource1.getEntity() instanceof EntityPlayer) {
			EntityPlayer entityPlayer2 = (EntityPlayer)damageSource1.getEntity();
