...
public class EntityAIPlay extends EntityAIBase {
	...
	public boolean shouldExecute() {
		if(this.villagerObj.getGrowingAge() >= 0) {
			...
			List list1 = this.villagerObj.worldObj.getEntitiesWithinAABB(EntityVillager.class, this.villagerObj.boundingBox.expand(6.0D, 3.0D, 6.0D));
			...
			if(this.targetVillager == null) {
				Vec3D vec3D9 = RandomPositionGenerator.func_48396_a(this.villagerObj, 16, 3);
				if(vec3D9 == null) {
					return false;
				}
			}
	...
	public void updateTask() {
		...
		if(this.targetVillager != null) {
			...
			Vec3D vec3D1 = RandomPositionGenerator.func_48396_a(this.villagerObj, 16, 3);
			if(vec3D1 == null) {
				return;
			}

			this.villagerObj.getNavigator().func_48658_a(vec3D1.xCoord, vec3D1.yCoord, vec3D1.zCoord, this.field_48166_c);
		}
