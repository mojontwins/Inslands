...
abstract class ComponentNetherBridgePiece extends StructureComponent {
	...
	private int getTotalWeight(List list1) {
		...
		for(Iterator iterator4 = list1.iterator(); iterator4.hasNext(); i3 += structureNetherBridgePieceWeight5.field_40653_b) {
			structureNetherBridgePieceWeight5 = (StructureNetherBridgePieceWeight)iterator4.next();
			if(structureNetherBridgePieceWeight5.field_40651_d > 0 && structureNetherBridgePieceWeight5.field_40654_c < structureNetherBridgePieceWeight5.field_40651_d) {
				z2 = true;
			}
		}
	...
	private ComponentNetherBridgePiece getNextComponent(ComponentNetherBridgeStartPiece componentNetherBridgeStartPiece1, List list2, List list3, Random random4, int i5, int i6, int i7, int i8, int i9) {
		...
		while(i12 < 5 && z11) {
			...
			while(iterator14.hasNext()) {
				...
				i13 -= structureNetherBridgePieceWeight15.field_40653_b;
				if(i13 < 0) {
					if(!structureNetherBridgePieceWeight15.func_40649_a(i9) || structureNetherBridgePieceWeight15 == componentNetherBridgeStartPiece1.field_40296_a && !structureNetherBridgePieceWeight15.field_40652_e) {
						break;
					}
					...
					if(componentNetherBridgePiece16 != null) {
						++structureNetherBridgePieceWeight15.field_40654_c;
						componentNetherBridgeStartPiece1.field_40296_a = structureNetherBridgePieceWeight15;
						if(!structureNetherBridgePieceWeight15.func_40650_a()) {
		...
		ComponentNetherBridgeEnd componentNetherBridgeEnd17 = ComponentNetherBridgeEnd.func_40301_a(list3, random4, i5, i6, i7, i8, i9);
	...
	private StructureComponent getNextComponent(ComponentNetherBridgeStartPiece componentNetherBridgeStartPiece1, List list2, Random random3, int i4, int i5, int i6, int i7, int i8, boolean z9) {
		if(Math.abs(i4 - componentNetherBridgeStartPiece1.getBoundingBox().minX) <= 112 && Math.abs(i6 - componentNetherBridgeStartPiece1.getBoundingBox().minZ) <= 112) {
			List list12 = componentNetherBridgeStartPiece1.field_40294_b;
			if(z9) {
				list12 = componentNetherBridgeStartPiece1.field_40295_c;
			}
			...
			if(componentNetherBridgePiece11 != null) {
				...
				componentNetherBridgeStartPiece1.field_40293_d.add(componentNetherBridgePiece11);
			}

			return componentNetherBridgePiece11;
		} else {
			ComponentNetherBridgeEnd componentNetherBridgeEnd10 = ComponentNetherBridgeEnd.func_40301_a(list2, random3, i4, i5, i6, i7, i8);
