...
public class ItemMap extends ItemMapBase {
	...
	public Packet getUpdatePacket(ItemStack itemStack1, World world2, EntityPlayer entityPlayer3) {
		byte[] b4 = this.getMapData(itemStack1, world2).func_28154_a(itemStack1, world2, entityPlayer3);
		return b4 == null ? null : new Packet131MapData((short)Item.map.shiftedIndex, (short)itemStack1.getItemDamage(), b4);
	}
}
