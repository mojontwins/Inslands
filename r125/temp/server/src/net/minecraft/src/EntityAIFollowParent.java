...
public class EntityAIFollowParent extends EntityAIBase {
	...
	public boolean shouldExecute() {
		if(this.childAnimal.getGrowingAge() >= 0) {
			...
			List list1 = this.childAnimal.worldObj.getEntitiesWithinAABB(this.childAnimal.getClass(), this.childAnimal.boundingBox.expand(8.0D, 4.0D, 8.0D));
	...
	public void updateTask() {
		if(--this.field_48138_d <= 0) {
			...
			this.childAnimal.getNavigator().func_48652_a(this.parentAnimal, this.field_48140_c);
		}
	}
}
