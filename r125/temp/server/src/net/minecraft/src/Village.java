...
public class Village {
	...
	public VillageDoorInfo findNearestDoor(int i1, int i2, int i3) {
		...
		Iterator iterator6 = this.villageDoorInfoList.iterator();
	...
	public VillageDoorInfo getVillageDoorAt(int i1, int i2, int i3) {
		if(this.center.getDistanceSquared(i1, i2, i3) > (float)(this.villageRadius * this.villageRadius)) {
			...
			Iterator iterator4 = this.villageDoorInfoList.iterator();
	...
	public void addOrRenewAgressor(EntityLiving entityLiving1) {
		Iterator iterator2 = this.villageAgressors.iterator();
	...
	private void removeDeadAndOldAgressors() {
		Iterator iterator1 = this.villageAgressors.iterator();
	...
	private void removeDeadAndOutOfRangeDoors() {
		...
		Iterator iterator3 = this.villageDoorInfoList.iterator();
	...
	private void updateVillageRadiusAndCenter() {
		...
		if(i1 == 0) {
			...
			VillageDoorInfo villageDoorInfo4;
			for(Iterator iterator3 = this.villageDoorInfoList.iterator(); iterator3.hasNext(); i2 = Math.max(villageDoorInfo4.getDistanceSquared(this.center.posX, this.center.posY, this.center.posZ), i2)) {
				villageDoorInfo4 = (VillageDoorInfo)iterator3.next();
			}
