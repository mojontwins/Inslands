...
public final class SajParser {
	...
	private String numberToken(PositionTrackingPushbackReader positionTrackingPushbackReader1) throws InvalidSyntaxException, IOException {
	...
	private String nonNegativeNumberToken(PositionTrackingPushbackReader positionTrackingPushbackReader1) throws InvalidSyntaxException, IOException {
		StringBuilder stringBuilder2 = new StringBuilder();
		char c3 = (char)positionTrackingPushbackReader1.read();
		if(48 == c3) {
	...
	private char nonZeroDigitToken(PositionTrackingPushbackReader positionTrackingPushbackReader1) throws InvalidSyntaxException, IOException {
		char c3 = (char)positionTrackingPushbackReader1.read();
		switch(c3) {
		case '1':
		case '2':
	...
	private char digitToken(PositionTrackingPushbackReader positionTrackingPushbackReader1) throws InvalidSyntaxException, IOException {
		char c3 = (char)positionTrackingPushbackReader1.read();
		switch(c3) {
		case '0':
		case '1':
	...
	private String possibleFractionalComponent(PositionTrackingPushbackReader positionTrackingPushbackReader1) throws InvalidSyntaxException, IOException {
		StringBuilder stringBuilder2 = new StringBuilder();
		char c3 = (char)positionTrackingPushbackReader1.read();
		if(c3 == 46) {
			stringBuilder2.append('.');
	...
	private String possibleExponent(PositionTrackingPushbackReader positionTrackingPushbackReader1) throws InvalidSyntaxException, IOException {
		StringBuilder stringBuilder2 = new StringBuilder();
		char c3 = (char)positionTrackingPushbackReader1.read();
		if(c3 != 46 && c3 != 69) {
			positionTrackingPushbackReader1.unread(c3);
	...
	private char escapedStringChar(PositionTrackingPushbackReader positionTrackingPushbackReader1) throws InvalidSyntaxException, IOException {
		char c3 = (char)positionTrackingPushbackReader1.read();
		char c2;
		switch(c3) {
		case '\"':
	...
	private int hexadecimalNumber(PositionTrackingPushbackReader positionTrackingPushbackReader1) throws InvalidSyntaxException, IOException {
		char[] c2 = new char[4];
