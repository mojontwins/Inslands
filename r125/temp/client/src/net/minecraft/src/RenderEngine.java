...
public class RenderEngine {
	...
	public void updateDynamicTextures() {
		...
		for(int i2 = 0; i2 < this.textureList.size(); ++i2) {
			TextureFX textureFX3 = (TextureFX)this.textureList.get(i2);
	...
	public void refreshTextures() {
		...
		Iterator iterator2 = this.textureNameToImageMap.getKeySet().iterator();
		...
		iterator2 = this.textureContentsMap.keySet().iterator();
