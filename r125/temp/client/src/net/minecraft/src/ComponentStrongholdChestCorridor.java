...
public class ComponentStrongholdChestCorridor extends ComponentStronghold {
	...
	public ComponentStrongholdChestCorridor(int i1, Random random2, StructureBoundingBox structureBoundingBox3, int i4) {
		super(i1);
	...
	public static ComponentStrongholdChestCorridor findValidPlacement(List list0, Random random1, int i2, int i3, int i4, int i5, int i6) {
		...
		if(this.isLiquidInStructureBoundingBox(world1, structureBoundingBox3)) {
			...
			if(!this.hasMadeChest) {
				...
				if(structureBoundingBox3.isVecInside(i5, i4, i6)) {
					...
					this.createTreasureChestAtCurrentPosition(world1, structureBoundingBox3, random2, 3, 2, 3, chestLoot, 2 + random2.nextInt(2));
				}
			}
