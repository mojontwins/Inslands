...
public class EntityClientPlayerMP extends EntityPlayerSP {
	...
	public void sendChatMessage(String string1) {
		if(this.mc.ingameGUI.func_50013_c().size() == 0 || !((String)this.mc.ingameGUI.func_50013_c().get(this.mc.ingameGUI.func_50013_c().size() - 1)).equals(string1)) {
	...
	public void incrementStat(StatBase statBase1, int i2) {
		if(statBase1 != null) {
			if(!statBase1.isIndependent) {
				super.addStat(statBase1, i2);
			}
