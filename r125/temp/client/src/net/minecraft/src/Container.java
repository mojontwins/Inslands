				...
				if(i1 == -999) {
					...
					if(slot12 != null) {
						...
						if(itemStack13 == null) {
							...
							if(itemStack13.itemID == itemStack14.itemID && (!itemStack13.getHasSubtypes() || itemStack13.getItemDamage() == itemStack14.getItemDamage()) && ItemStack.func_46154_a(itemStack13, itemStack14)) {
								i10 = i2 == 0 ? itemStack14.stackSize : 1;
						...
						} else if(itemStack13.itemID == itemStack14.itemID && itemStack14.getMaxStackSize() > 1 && (!itemStack13.getHasSubtypes() || itemStack13.getItemDamage() == itemStack14.getItemDamage()) && ItemStack.func_46154_a(itemStack13, itemStack14)) {
	...
	protected boolean mergeItemStack(ItemStack itemStack1, int i2, int i3, boolean z4) {
		...
		if(itemStack1.isStackable()) {
			while(itemStack1.stackSize > 0 && (!z4 && i6 < i3 || z4 && i6 >= i2)) {
				...
				if(itemStack8 != null && itemStack8.itemID == itemStack1.itemID && (!itemStack1.getHasSubtypes() || itemStack1.getItemDamage() == itemStack8.getItemDamage()) && ItemStack.func_46154_a(itemStack1, itemStack8)) {
