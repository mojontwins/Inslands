...
public class EntityAIAvoidEntity extends EntityAIBase {
	...
	public boolean shouldExecute() {
		if(this.targetEntityClass == EntityPlayer.class) {
			...
			List list1 = this.theEntity.worldObj.getEntitiesWithinAABB(this.targetEntityClass, this.theEntity.boundingBox.expand((double)this.field_48241_e, 3.0D, (double)this.field_48241_e));
			if(list1.size() == 0) {
				return false;
			}
