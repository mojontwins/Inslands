...
public class TextureHDLavaFlowFX extends TextureFX implements TextureHDFX {
	...
	public void onTick() {
		...
		if(this.imageData != null) {
			...
			for(int i14 = 0; i14 < this.tileWidth * this.tileWidth; ++i14) {
				float f15 = this.buf1[i14 - this.tickCounter / 3 * this.tileWidth & widthMask2] * 2.0F;
				if(f15 > 1.0F) {
					f15 = 1.0F;
				}
				...
				j1 = (int)(f15 * 100.0F + 155.0F);
				l1 = (int)(f15 * f15 * 255.0F);
				j2 = (int)(f15 * f15 * f15 * f15 * 128.0F);
				...
				this.imageData[i14 * 4 + 0] = (byte)j1;
				this.imageData[i14 * 4 + 1] = (byte)l1;
				this.imageData[i14 * 4 + 2] = (byte)j2;
				this.imageData[i14 * 4 + 3] = -1;
			}
