...
public class AnvilSaveConverter extends SaveFormatOld {
	...
	public boolean convertMapFormat(String string1, IProgressUpdate iProgressUpdate2) {
		...
		this.func_48428_a(new File(file7, "region"), arrayList4, new WorldChunkManagerHell(BiomeGenBase.hell, 1.0F, 0.0F), arrayList3.size(), i9, iProgressUpdate2);
		this.func_48428_a(new File(file8, "region"), arrayList5, new WorldChunkManagerHell(BiomeGenBase.sky, 0.5F, 0.0F), arrayList3.size() + arrayList4.size(), i9, iProgressUpdate2);
	...
	private void func_48428_a(File file1, ArrayList arrayList2, WorldChunkManager worldChunkManager3, int i4, int i5, IProgressUpdate iProgressUpdate6) {
	...
	private void func_48432_a(File file1, ArrayList arrayList2) {
