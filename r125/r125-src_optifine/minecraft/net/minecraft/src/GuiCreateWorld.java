...
public class GuiCreateWorld extends GuiScreen {
	...
	private void func_35363_g() {
		...
		this.worldTypeButton.displayString = stringTranslate1.translateKey("selectWorld.mapType") + " " + stringTranslate1.translateKey(WorldType.worldTypes[this.field_46030_z].getTranslateName());
	}
	...
	protected void actionPerformed(GuiButton guiButton1) {
		if(guiButton1.enabled) {
			if(guiButton1.id == 1) {
				...
				this.mc.startWorld(this.folderName, this.textboxWorldName.getText(), new WorldSettings(j2, b9, this.field_35365_g, this.field_40232_h, WorldType.worldTypes[this.field_46030_z]));
				this.mc.displayGuiScreen((GuiScreen)null);
