...
public class GuiGameOver extends GuiScreen {
	...
	public void initGui() {
		...
		for(Iterator iterator1 = this.controlList.iterator(); iterator1.hasNext(); guiButton2.enabled = false) {
	...
	public void updateScreen() {
		...
		if(this.cooldownTimer == 20) {
			for(Iterator iterator1 = this.controlList.iterator(); iterator1.hasNext(); guiButton2.enabled = true) {
				guiButton2 = (GuiButton)iterator1.next();
			}
		}
