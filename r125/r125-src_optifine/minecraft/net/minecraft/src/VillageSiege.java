...
public class VillageSiege {
	...
	private boolean func_48574_b() {
		List list1 = this.field_48582_a.playerEntities;
		...
		do {
			...
			for(int i7 = 0; i7 < 10; ++i7) {
				...
				z6 = false;
				Iterator iterator8 = this.field_48582_a.villageCollectionObj.func_48554_b().iterator();
	...
	private Vec3D func_48572_a(int i1, int i2, int i3) {
		for(int i4 = 0; i4 < 10; ++i4) {
			int i5 = i1 + this.field_48582_a.rand.nextInt(16) - 8;
			int i6 = i2 + this.field_48582_a.rand.nextInt(6) - 3;
			int i7 = i3 + this.field_48582_a.rand.nextInt(16) - 8;
