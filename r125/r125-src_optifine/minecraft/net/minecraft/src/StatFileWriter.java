...
public class StatFileWriter {
	...
	public static Map func_27177_a(String string0) {
		...
		try {
			...
			List list5 = jsonRootNode4.getArrayNode(new Object[]{"stats-change"});
			Iterator iterator6 = list5.iterator();

			while(iterator6.hasNext()) {
				JsonNode jsonNode7 = (JsonNode)iterator6.next();
				Map map8 = jsonNode7.getFields();
				Entry map$Entry9 = (Entry)map8.entrySet().iterator().next();
				int i10 = Integer.parseInt(((JsonStringNode)map$Entry9.getKey()).getText());
				int i11 = Integer.parseInt(((JsonNode)map$Entry9.getValue()).getText());
			...
			invalidSyntaxException13.printStackTrace();
		}
