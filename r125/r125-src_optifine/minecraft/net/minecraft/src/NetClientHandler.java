...
public class NetClientHandler extends NetHandler {
	...
	public void handleEntityExpOrb(Packet26EntityExpOrb packet26EntityExpOrb1) {
	...
	public void func_48487_a(Packet51MapChunk packet51MapChunk1) {
	...
	public void handleMobSpawn(Packet24MobSpawn packet24MobSpawn1) {
		...
		Entity[] entity11 = entityLiving10.getParts();
		if(entity11 != null) {
		...
		List list14 = packet24MobSpawn1.getMetadata();
		if(list14 != null) {
			entityLiving10.getDataWatcher().updateWatchedObjectsFromList(list14);
		}
	...
	public void handleEntityEffect(Packet41EntityEffect packet41EntityEffect1) {
	...
	public void handleRemoveEntityEffect(Packet42RemoveEntityEffect packet42RemoveEntityEffect1) {
