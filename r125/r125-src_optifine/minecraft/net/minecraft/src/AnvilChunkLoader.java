...
public class AnvilChunkLoader implements IThreadedFileIO, IChunkLoader {
	...
	public Chunk loadChunk(World world1, int i2, int i3) throws IOException {
		...
		synchronized(this.field_48450_c) {
			if(this.field_48449_b.contains(chunkCoordIntPair5)) {
				for(int i7 = 0; i7 < this.field_48451_a.size(); ++i7) {
					if(((AnvilChunkLoaderPending)this.field_48451_a.get(i7)).field_48427_a.equals(chunkCoordIntPair5)) {
						nBTTagCompound4 = ((AnvilChunkLoaderPending)this.field_48451_a.get(i7)).field_48426_b;
						break;
					}
				}
			}
	...
	protected void func_48446_a(ChunkCoordIntPair chunkCoordIntPair1, NBTTagCompound nBTTagCompound2) {
		...
		synchronized(this.field_48450_c) {
			if(this.field_48449_b.contains(chunkCoordIntPair1)) {
				for(int i4 = 0; i4 < this.field_48451_a.size(); ++i4) {
					if(((AnvilChunkLoaderPending)this.field_48451_a.get(i4)).field_48427_a.equals(chunkCoordIntPair1)) {
						this.field_48451_a.set(i4, new AnvilChunkLoaderPending(chunkCoordIntPair1, nBTTagCompound2));
						return;
					}
				}
			}
	...
	public boolean writeNextIO() {
		...
		synchronized(this.field_48450_c) {
			...
			anvilChunkLoaderPending1 = (AnvilChunkLoaderPending)this.field_48451_a.remove(0);
			this.field_48449_b.remove(anvilChunkLoaderPending1.field_48427_a);
		}
