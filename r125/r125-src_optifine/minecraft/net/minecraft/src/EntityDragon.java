...
public class EntityDragon extends EntityDragonBase {
	...
	public double[] func_40160_a(int i1, float f2) {
		if(this.health <= 0) {
			f2 = 0.0F;
		}

		f2 = 1.0F - f2;
		int i3 = this.field_40164_e - i1 * 1 & 63;
		int i4 = this.field_40164_e - i1 * 1 - 1 & 63;
		double[] d5 = new double[3];
		double d6 = this.field_40162_d[i3][0];

		double d8;
		for(d8 = this.field_40162_d[i4][0] - d6; d8 < -180.0D; d8 += 360.0D) {
		}
		...
		d6 = this.field_40162_d[i3][1];
		d8 = this.field_40162_d[i4][1] - d6;
		d5[1] = d6 + d8 * (double)f2;
		d5[2] = this.field_40162_d[i3][2] + (this.field_40162_d[i4][2] - this.field_40162_d[i3][2]) * (double)f2;
		return d5;
	}
		...
		if(this.health <= 0) {
			...
			if(this.field_40164_e < 0) {
				for(int i2 = 0; i2 < this.field_40162_d.length; ++i2) {
					this.field_40162_d[i2][0] = (double)this.rotationYaw;
					this.field_40162_d[i2][1] = this.posY;
				}
			}
			...
			f26 = (float)(this.func_40160_a(5, 1.0F)[1] - this.func_40160_a(10, 1.0F)[1]) * 10.0F / 180.0F * (float)Math.PI;
			...
			double[] d29 = this.func_40160_a(5, 1.0F);
			double[] d9 = this.func_40160_a(0, 1.0F);
			...
			for(int i30 = 0; i30 < 3; ++i30) {
				...
				double[] d34 = this.func_40160_a(12 + i30 * 2, 1.0F);
