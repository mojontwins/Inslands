...
public class StructureMineshaftPieces {
	...
	private static StructureComponent getRandomComponent(List list0, Random random1, int i2, int i3, int i4, int i5, int i6) {
	...
	private static StructureComponent getNextMineShaftComponent(StructureComponent structureComponent0, List list1, Random random2, int i3, int i4, int i5, int i6, int i7) {
		if(i7 > 8) {
			return null;
	...
	static StructureComponent getNextComponent(StructureComponent structureComponent0, List list1, Random random2, int i3, int i4, int i5, int i6, int i7) {
