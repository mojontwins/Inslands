...
public class RandomPositionGenerator {
	...
	public static Vec3D func_48396_a(EntityCreature entityCreature0, int i1, int i2) {
		return func_48393_c(entityCreature0, i1, i2, (Vec3D)null);
	}

	public static Vec3D func_48395_a(EntityCreature entityCreature0, int i1, int i2, Vec3D vec3D3) {
		field_48397_a.xCoord = vec3D3.xCoord - entityCreature0.posX;
		field_48397_a.yCoord = vec3D3.yCoord - entityCreature0.posY;
		field_48397_a.zCoord = vec3D3.zCoord - entityCreature0.posZ;
		return func_48393_c(entityCreature0, i1, i2, field_48397_a);
	}

	public static Vec3D func_48394_b(EntityCreature entityCreature0, int i1, int i2, Vec3D vec3D3) {
		field_48397_a.xCoord = entityCreature0.posX - vec3D3.xCoord;
		field_48397_a.yCoord = entityCreature0.posY - vec3D3.yCoord;
		field_48397_a.zCoord = entityCreature0.posZ - vec3D3.zCoord;
		return func_48393_c(entityCreature0, i1, i2, field_48397_a);
	}

	private static Vec3D func_48393_c(EntityCreature entityCreature0, int i1, int i2, Vec3D vec3D3) {
