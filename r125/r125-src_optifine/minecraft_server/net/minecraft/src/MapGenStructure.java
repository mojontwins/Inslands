...
public abstract class MapGenStructure extends MapGenBase {
	...
	protected void recursiveGenerate(World world1, int i2, int i3, int i4, int i5, byte[] b6) {
		if(!this.coordMap.containsKey(ChunkCoordIntPair.chunkXZ2Int(i2, i3))) {
			...
			if(this.canSpawnStructureAtCoords(i2, i3)) {
				...
				this.coordMap.put(ChunkCoordIntPair.chunkXZ2Int(i2, i3), structureStart7);
			}

		}
	}

	public boolean generateStructuresInChunk(World world1, Random random2, int i3, int i4) {
		int i5 = (i3 << 4) + 8;
		int i6 = (i4 << 4) + 8;
		boolean z7 = false;
		Iterator iterator8 = this.coordMap.values().iterator();
	...
	public boolean func_40204_a(int i1, int i2, int i3) {
		Iterator iterator4 = this.coordMap.values().iterator();
		...
		while(true) {
			...
			Iterator iterator6 = structureStart5.getComponents().iterator();
	...
	public ChunkPosition getNearestInstance(World world1, int i2, int i3, int i4) {
		...
		if(chunkPosition15 != null) {
			...
			List list25 = this.func_40203_a();
			if(list25 != null) {
				ChunkPosition chunkPosition26 = null;
				Iterator iterator27 = list25.iterator();
