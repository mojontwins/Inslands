...
public class BlockChest extends BlockContainer {
	...
	public boolean blockActivated(World world1, int i2, int i3, int i4, EntityPlayer entityPlayer5) {
		...
		if(object6 == null) {
			...
			return true;
		} else if(func_50009_h(world1, i2, i3, i4)) {
			return true;
		} else if(world1.getBlockId(i2 - 1, i3, i4) == this.blockID && (world1.isBlockNormalCube(i2 - 1, i3 + 1, i4) || func_50009_h(world1, i2 - 1, i3, i4))) {
			return true;
		} else if(world1.getBlockId(i2 + 1, i3, i4) == this.blockID && (world1.isBlockNormalCube(i2 + 1, i3 + 1, i4) || func_50009_h(world1, i2 + 1, i3, i4))) {
			return true;
		} else if(world1.getBlockId(i2, i3, i4 - 1) != this.blockID || !world1.isBlockNormalCube(i2, i3 + 1, i4 - 1) && !func_50009_h(world1, i2, i3, i4 - 1)) {
			if(world1.getBlockId(i2, i3, i4 + 1) != this.blockID || !world1.isBlockNormalCube(i2, i3 + 1, i4 + 1) && !func_50009_h(world1, i2, i3, i4 + 1)) {
				if(world1.getBlockId(i2 - 1, i3, i4) == this.blockID) {
	...
	private static boolean func_50009_h(World world0, int i1, int i2, int i3) {
		Iterator iterator4 = world0.getEntitiesWithinAABB(EntityOcelot.class, AxisAlignedBB.getBoundingBoxFromPool((double)i1, (double)(i2 + 1), (double)i3, (double)(i1 + 1), (double)(i2 + 2), (double)(i3 + 1))).iterator();
