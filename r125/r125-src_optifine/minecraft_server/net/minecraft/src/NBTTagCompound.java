...
public class NBTTagCompound extends NBTBase {
	...
	public void func_48446_a(String string1, int[] i2) {
	...
	public int[] func_48445_l(String string1) {
		return !this.tagMap.containsKey(string1) ? new int[0] : ((NBTTagIntArray)this.tagMap.get(string1)).field_48447_a;
	}
	...
	public NBTBase copy() {
		...
		Iterator iterator2 = this.tagMap.keySet().iterator();
