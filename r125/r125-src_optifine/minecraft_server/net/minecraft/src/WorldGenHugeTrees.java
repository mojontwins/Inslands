...
public class WorldGenHugeTrees extends WorldGenerator {
	...
	public WorldGenHugeTrees(boolean z1, int i2, int i3, int i4) {
		super(z1);
		this.field_48406_a = i2;
		this.woodMetadata = i3;
		this.leavesMetadata = i4;
	}

	public boolean generate(World world1, Random random2, int i3, int i4, int i5) {
		int i6 = random2.nextInt(3) + this.field_48406_a;
		boolean z7 = true;
		if(i4 >= 1 && i4 + i6 + 1 <= 256) {
			int i8;
			int i10;
			...
			if(!z7) {
				...
				if((i8 == Block.grass.blockID || i8 == Block.dirt.blockID) && i4 < 256 - i6 - 1) {
					...
					this.func_48403_a(world1, i3, i5, i4 + i6, 2, random2);
					...
					for(int i14 = i4 + i6 - 2 - random2.nextInt(4); i14 > i4 + i6 / 2; i14 -= 2 + random2.nextInt(4)) {
						...
						this.func_48403_a(world1, i11, i12, i14, 0, random2);
	...
	private void func_48403_a(World world1, int i2, int i3, int i4, int i5, Random random6) {
		byte b7 = 2;
