...
public class StructureStrongholdPieces {
	...
	private static boolean canAddStructurePieces() {
		...
		for(Iterator iterator1 = structurePieceList.iterator(); iterator1.hasNext(); totalWeight += structureStrongholdPieceWeight2.pieceWeight) {
	...
	private static ComponentStronghold getStrongholdComponentFromWeightedPiece(Class class0, List list1, Random random2, int i3, int i4, int i5, int i6, int i7) {
		Object object8 = null;
		...
		} else if(class0 == ComponentStrongholdPortalRoom.class) {
	...
	private static ComponentStronghold getNextComponent(ComponentStrongholdStairs2 componentStrongholdStairs20, List list1, Random random2, int i3, int i4, int i5, int i6, int i7) {
		if(!canAddStructurePieces()) {
			...
			while(i13 < 5) {
				...
				Iterator iterator10 = structurePieceList.iterator();
				...
				while(iterator10.hasNext()) {
					...
					if(i9 < 0) {
						if(!structureStrongholdPieceWeight11.canSpawnMoreStructuresOfType(i7) || structureStrongholdPieceWeight11 == componentStrongholdStairs20.field_35329_a) {
							break;
						}
			...
			StructureBoundingBox structureBoundingBox14 = ComponentStrongholdCorridor.func_35342_a(list1, random2, i3, i4, i5, i6);
	...
	private static StructureComponent getNextValidComponent(ComponentStrongholdStairs2 componentStrongholdStairs20, List list1, Random random2, int i3, int i4, int i5, int i6, int i7) {
		if(i7 > 50) {
			return null;
	...
	static StructureComponent getNextValidComponentAccess(ComponentStrongholdStairs2 componentStrongholdStairs20, List list1, Random random2, int i3, int i4, int i5, int i6, int i7) {
