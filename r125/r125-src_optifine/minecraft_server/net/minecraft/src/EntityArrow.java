...
public class EntityArrow extends Entity {
					...
					if(movingObjectPosition3.entityHit.attackEntityFrom(damageSource21, i20)) {
						if(movingObjectPosition3.entityHit instanceof EntityLiving) {
							...
							if(this.field_46010_n > 0) {
								...
								if(f23 > 0.0F) {
									movingObjectPosition3.entityHit.addVelocity(this.motionX * (double)this.field_46010_n * (double)0.6F / (double)f23, 0.1D, this.motionZ * (double)this.field_46010_n * (double)0.6F / (double)f23);
								}
							}
						}
	...
	public void func_46007_b(int i1) {
		this.field_46010_n = i1;
	}
