...
public class EntitySlime extends EntityLiving implements IMob {
	...
	public void onCollideWithPlayer(EntityPlayer entityPlayer1) {
		if(this.func_40119_C()) {
			int i2 = this.getSlimeSize();
			if(this.canEntityBeSeen(entityPlayer1) && (double)this.getDistanceToEntity(entityPlayer1) < 0.6D * (double)i2 && entityPlayer1.attackEntityFrom(DamageSource.causeMobDamage(this), this.func_40113_D())) {
