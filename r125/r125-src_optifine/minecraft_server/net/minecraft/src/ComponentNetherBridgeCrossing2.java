...
public class ComponentNetherBridgeCrossing2 extends ComponentNetherBridgePiece {
	public ComponentNetherBridgeCrossing2(int i1, Random random2, StructureBoundingBox structureBoundingBox3, int i4) {
		super(i1);
	...
	public static ComponentNetherBridgeCrossing2 createValidComponent(List list0, Random random1, int i2, int i3, int i4, int i5, int i6) {
