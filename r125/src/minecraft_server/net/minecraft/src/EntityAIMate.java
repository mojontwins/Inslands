...
public class EntityAIMate extends EntityAIBase {
	...
	public void updateTask() {
		...
		this.theAnimal.getNavigator().func_48652_a(this.targetMate, this.field_48202_c);
		++this.field_48201_b;
	...
	private EntityAnimal func_48198_f() {
		float f1 = 8.0F;
		List list2 = this.theWorld.getEntitiesWithinAABB(this.theAnimal.getClass(), this.theAnimal.boundingBox.expand((double)f1, (double)f1, (double)f1));
		...
		} while(!this.theAnimal.func_48362_b(entityAnimal5));
