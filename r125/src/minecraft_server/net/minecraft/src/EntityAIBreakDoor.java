...
public class EntityAIBreakDoor extends EntityAIDoorInteract {
	...
	public boolean shouldExecute() {
		return !super.shouldExecute() ? false : !this.targetDoor.func_48135_d(this.theEntity.worldObj, this.entityPosX, this.entityPosY, this.entityPosZ);
	}
	...
	public boolean continueExecuting() {
		...
		return this.field_48194_i >= 0 && !this.targetDoor.func_48135_d(this.theEntity.worldObj, this.entityPosX, this.entityPosY, this.entityPosZ) && d1 < 4.0D;
	}
	...
	public void updateTask() {
		...
		if(--this.field_48194_i == 0 && this.theEntity.worldObj.difficultySetting == 3) {
