...
public abstract class EntityThrowable extends Entity {
	...
	public EntityThrowable(World world1, EntityLiving entityLiving2) {
		...
		this.motionY = (double)(-MathHelper.sin((this.rotationPitch + this.func_40040_d()) / 180.0F * (float)Math.PI) * f3);
		this.setThrowableHeading(this.motionX, this.motionY, this.motionZ, this.func_40044_c(), 1.0F);
	}
