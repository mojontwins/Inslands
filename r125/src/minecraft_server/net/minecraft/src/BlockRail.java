...
public class BlockRail extends Block {
	...
	private void refreshTrackShape(World world1, int i2, int i3, int i4, boolean z5) {
		if(!world1.isRemote) {
			(new RailLogic(this, world1, i2, i3, i4)).refreshTrackShape(world1.isBlockIndirectlyGettingPowered(i2, i3, i4), z5);
		}
	}

	private boolean isNeighborRailPowered(World world1, int i2, int i3, int i4, int i5, boolean z6, int i7) {
		if(i7 >= 8) {
			return false;
		} else {
			int i8 = i5 & 7;
	...
	private boolean isRailPassingPower(World world1, int i2, int i3, int i4, boolean z5, int i6, int i7) {
