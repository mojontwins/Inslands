...
public class EntityAIFollowOwner extends EntityAIBase {
	...
	public void startExecuting() {
		...
		this.field_48253_i = this.thePet.getNavigator().func_48649_a();
		this.thePet.getNavigator().func_48656_a(false);
	}

	public void resetTask() {
		this.theOwner = null;
		this.petPathfinder.clearPathEntity();
		this.thePet.getNavigator().func_48656_a(this.field_48253_i);
	}
	...
	public void updateTask() {
		...
		if(!this.thePet.isSitting()) {
			if(--this.field_48252_h <= 0) {
				...
				if(!this.petPathfinder.func_48652_a(this.theOwner, this.field_48245_f)) {
