...
class RailLogic {
	...
	private boolean canConnectTo(RailLogic railLogic1) {
	...
	public void refreshTrackShape(boolean z1, boolean z2) {
		boolean z3 = this.canConnectFrom(this.trackX, this.trackY, this.trackZ - 1);
		boolean z4 = this.canConnectFrom(this.trackX, this.trackY, this.trackZ + 1);
		boolean z5 = this.canConnectFrom(this.trackX - 1, this.trackY, this.trackZ);
		boolean z6 = this.canConnectFrom(this.trackX + 1, this.trackY, this.trackZ);
		byte b7 = -1;
		if((z3 || z4) && !z5 && !z6) {
			b7 = 0;
		}
