...
public class EntityLookHelper {
	...
	public void setLookPositionWithEntity(Entity entity1, float f2, float f3) {
		...
		this.field_46066_b = f2;
		this.field_46067_c = f3;
	...
	public void setLookPosition(double d1, double d3, double d5, float f7, float f8) {
		...
		this.posY = d3;
		this.posZ = d5;
		this.field_46066_b = f7;
		this.field_46067_c = f8;
		this.field_46064_d = true;
	}
	...
	public void onUpdateLook() {
		...
		if(this.field_46064_d) {
			...
			this.entity.rotationPitch = this.updateRotation(this.entity.rotationPitch, f10, this.field_46067_c);
			this.entity.rotationYawHead = this.updateRotation(this.entity.rotationYawHead, f9, this.field_46066_b);
		} else {
