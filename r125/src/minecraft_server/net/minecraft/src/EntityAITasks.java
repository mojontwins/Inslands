...
public class EntityAITasks {
	...
	public void onUpdateTasks() {
		...
		Iterator iterator2 = this.tasksToDo.iterator();
		...
		while(true) {
			...
			while(true) {
				...
				if(!this.func_46136_a(entityAITaskEntry3) || !entityAITaskEntry3.action.continueExecuting()) {
			...
			if(this.func_46136_a(entityAITaskEntry3) && entityAITaskEntry3.action.shouldExecute()) {
	...
	private boolean func_46136_a(EntityAITaskEntry entityAITaskEntry1) {
		Iterator iterator2 = this.tasksToDo.iterator();
