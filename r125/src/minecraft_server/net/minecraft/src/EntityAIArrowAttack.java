...
public class EntityAIArrowAttack extends EntityAIBase {
	...
	public void updateTask() {
		...
		boolean z5 = this.entityHost.func_48318_al().canSee(this.attackTarget);
		if(z5) {
			++this.field_48177_f;
		} else {
		...
		if(d3 <= d1 && this.field_48177_f >= 20) {
			this.entityHost.getNavigator().clearPathEntity();
		} else {
			this.entityHost.getNavigator().func_48652_a(this.attackTarget, this.field_48180_e);
		}
