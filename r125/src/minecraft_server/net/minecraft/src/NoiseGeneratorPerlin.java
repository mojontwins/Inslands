...
public class NoiseGeneratorPerlin extends NoiseGenerator {
	...
	public final double func_4102_a(int i1, double d2, double d4) {
		int i6 = i1 & 15;
	...
	public void func_646_a(double[] d1, double d2, double d4, double d6, int i8, int i9, int i10, double d11, double d13, double d15, double d17) {
		int i10001;
		int i19;
		int i22;
		double d31;
		...
		if(i9 == 1) {
			...
			for(int i30 = 0; i30 < i8; ++i30) {
				...
				for(i37 = 0; i37 < i10; ++i37) {
					...
					d70 = this.lerp(d35, this.func_4102_a(this.permutations[i66], d31, d38), this.grad(this.permutations[i22], d31 - 1.0D, 0.0D, d38));
