...
public class ChunkProvider implements IChunkProvider {
	...
	public boolean unload100OldestChunks() {
		...
		for(i1 = 0; i1 < 10; ++i1) {
			...
			Chunk chunk4 = (Chunk)this.chunkList.get(this.field_35557_h++);
			EntityPlayer entityPlayer5 = this.worldObj.func_48087_a((double)(chunk4.xPosition << 4) + 8.0D, (double)(chunk4.zPosition << 4) + 8.0D, 288.0D);
