...
public abstract class EntityAIDoorInteract extends EntityAIBase {
	...
	public boolean shouldExecute() {
		if(!this.theEntity.isCollidedHorizontally) {
			...
			if(pathEntity2 != null && !pathEntity2.isFinished() && pathNavigate1.func_48657_b()) {
				for(int i3 = 0; i3 < Math.min(pathEntity2.getCurrentPathIndex() + 2, pathEntity2.getCurrentPathLength()); ++i3) {
					...
					if(this.theEntity.getDistanceSq((double)this.entityPosX, this.theEntity.posY, (double)this.entityPosZ) <= 2.25D) {
						this.targetDoor = this.func_48185_a(this.entityPosX, this.entityPosY, this.entityPosZ);
	...
	public void updateTask() {
		...
		float f3 = this.field_48187_g * f1 + this.field_48193_h * f2;
		if(f3 < 0.0F) {
	...
	private BlockDoor func_48185_a(int i1, int i2, int i3) {
