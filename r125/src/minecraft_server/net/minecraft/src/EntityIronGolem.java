...
public class EntityIronGolem extends EntityGolem {
	...
	protected void updateAITick() {
		if(--this.field_48385_b <= 0) {
			this.field_48385_b = 70 + this.rand.nextInt(50);
	...
	public void onLivingUpdate() {
		...
		if(this.field_48386_c > 0) {
			--this.field_48386_c;
		}

		if(this.field_48384_g > 0) {
			--this.field_48384_g;
		}
	...
	public boolean func_48336_a(Class class1) {
		return this.func_48379_n_() && EntityPlayer.class.isAssignableFrom(class1) ? false : super.func_48336_a(class1);
	}

	public void writeEntityToNBT(NBTTagCompound nBTTagCompound1) {
		super.writeEntityToNBT(nBTTagCompound1);
		nBTTagCompound1.setBoolean("PlayerCreated", this.func_48379_n_());
	}

	public void readEntityFromNBT(NBTTagCompound nBTTagCompound1) {
		super.readEntityFromNBT(nBTTagCompound1);
		this.func_48381_b(nBTTagCompound1.getBoolean("PlayerCreated"));
	}

	public boolean attackEntityAsMob(Entity entity1) {
		this.field_48386_c = 10;
	...
	public void func_48383_a(boolean z1) {
		this.field_48384_g = z1 ? 400 : 0;
	...
	public void func_48381_b(boolean z1) {
