...
public class WorldGenTrees extends WorldGenerator {
	...
	public WorldGenTrees(boolean z1, int i2, int i3, int i4, boolean z5) {
		super(z1);
		this.field_48402_a = i2;
		this.field_48401_c = i3;
		this.field_48399_d = i4;
		this.field_48400_b = z5;
	}

	public boolean generate(World world1, Random random2, int i3, int i4, int i5) {
		int i6 = random2.nextInt(3) + this.field_48402_a;
		boolean z7 = true;
		if(i4 >= 1 && i4 + i6 + 1 <= 256) {
			int i8;
			byte b9;
			...
			if(!z7) {
				...
				if((i8 == Block.grass.blockID || i8 == Block.dirt.blockID) && i4 < 256 - i6 - 1) {
					this.func_50023_a(world1, i3, i4 - 1, i5, Block.dirt.blockID);
					b9 = 3;
					byte b18 = 0;
						...
						for(i14 = i3 - i13; i14 <= i3 + i13; ++i14) {
							...
							for(int i16 = i5 - i13; i16 <= i5 + i13; ++i16) {
								...
								if((Math.abs(i15) != i13 || Math.abs(i17) != i13 || random2.nextInt(2) != 0 && i12 != 0) && !Block.opaqueCubeLookup[world1.getBlockId(i14, i11, i16)]) {
									this.setBlockAndMetadata(world1, i14, i11, i16, Block.leaves.blockID, this.field_48399_d);
								}
							}
						}
					}
					...
					for(i11 = 0; i11 < i6; ++i11) {
						...
						if(i12 == 0 || i12 == Block.leaves.blockID) {
							this.setBlockAndMetadata(world1, i3, i4 + i11, i5, Block.wood.blockID, this.field_48401_c);
							if(this.field_48400_b && i11 > 0) {
								...
								for(i15 = i5 - i13; i15 <= i5 + i13; ++i15) {
									if(world1.getBlockId(i14, i11, i15) == Block.leaves.blockID) {
										if(random2.nextInt(4) == 0 && world1.getBlockId(i14 - 1, i11, i15) == 0) {
											this.func_48398_a(world1, i14 - 1, i11, i15, 8);
										}

										if(random2.nextInt(4) == 0 && world1.getBlockId(i14 + 1, i11, i15) == 0) {
											this.func_48398_a(world1, i14 + 1, i11, i15, 2);
										}

										if(random2.nextInt(4) == 0 && world1.getBlockId(i14, i11, i15 - 1) == 0) {
											this.func_48398_a(world1, i14, i11, i15 - 1, 1);
										}

										if(random2.nextInt(4) == 0 && world1.getBlockId(i14, i11, i15 + 1) == 0) {
											this.func_48398_a(world1, i14, i11, i15 + 1, 4);
										}
									}
								}
							}
	...
	private void func_48398_a(World world1, int i2, int i3, int i4, int i5) {
