...
public class NetLoginHandler extends NetHandler {
	...
	public void doLogin(Packet1Login packet1Login1) {
		...
		if(entityPlayerMP2 != null) {
			...
			entityPlayerMP2.itemInWorldManager.func_35695_b(worldServer3.getWorldInfo().getGameType());
			...
			Iterator iterator6 = entityPlayerMP2.getActivePotionEffects().iterator();
