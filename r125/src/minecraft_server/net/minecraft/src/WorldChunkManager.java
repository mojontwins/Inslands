...
public class WorldChunkManager {
	...
	public WorldChunkManager(long j1, WorldType worldType3) {
		this();
		GenLayer[] genLayer4 = GenLayer.func_48391_a(j1, worldType3);
	...
	public ChunkPosition findBiomePosition(int i1, int i2, int i3, List list4, Random random5) {
		int i6 = i1 - i3 >> 2;
		int i7 = i2 - i3 >> 2;
		int i8 = i1 + i3 >> 2;
		int i9 = i2 + i3 >> 2;
