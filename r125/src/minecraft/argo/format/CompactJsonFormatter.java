...
public final class CompactJsonFormatter implements JsonFormatter {
	...
	private void formatJsonNode(JsonNode jsonNode1, Writer writer2) throws IOException {
		boolean z3 = true;
		Iterator iterator4;
		switch(CompactJsonFormatter.SyntheticClass_1.$SwitchMap$argo$jdom$JsonNodeType[jsonNode1.getType().ordinal()]) {
		case 1:
			writer2.append('[');
	...
	static final class SyntheticClass_1 {
		static final int[] $SwitchMap$argo$jdom$JsonNodeType = new int[JsonNodeType.values().length];

		static {
			try {
				$SwitchMap$argo$jdom$JsonNodeType[JsonNodeType.ARRAY.ordinal()] = 1;
			} catch (NoSuchFieldError noSuchFieldError7) {
			}

			try {
				$SwitchMap$argo$jdom$JsonNodeType[JsonNodeType.OBJECT.ordinal()] = 2;
			} catch (NoSuchFieldError noSuchFieldError6) {
			}

			try {
				$SwitchMap$argo$jdom$JsonNodeType[JsonNodeType.STRING.ordinal()] = 3;
			} catch (NoSuchFieldError noSuchFieldError5) {
			}

			try {
				$SwitchMap$argo$jdom$JsonNodeType[JsonNodeType.NUMBER.ordinal()] = 4;
			} catch (NoSuchFieldError noSuchFieldError4) {
			}

			try {
				$SwitchMap$argo$jdom$JsonNodeType[JsonNodeType.FALSE.ordinal()] = 5;
			} catch (NoSuchFieldError noSuchFieldError3) {
			}

			try {
				$SwitchMap$argo$jdom$JsonNodeType[JsonNodeType.TRUE.ordinal()] = 6;
			} catch (NoSuchFieldError noSuchFieldError2) {
			}

			try {
				$SwitchMap$argo$jdom$JsonNodeType[JsonNodeType.NULL.ordinal()] = 7;
