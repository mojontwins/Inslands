...
public class GuiMultiplayer extends GuiScreen {
	...
	static List getServerList(GuiMultiplayer guiMultiplayer0) {
	...
	static void pollServer(GuiMultiplayer guiMultiplayer0, ServerNBTStorage serverNBTStorage1) throws IOException {
