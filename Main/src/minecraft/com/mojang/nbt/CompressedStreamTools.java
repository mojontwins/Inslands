...
public class CompressedStreamTools {
	public static NBTTagCompound readCompressed(InputStream inputStream0) throws IOException {
		...
		try {
			nBTTagCompound2 = readNBT(dataInputStream1);
		} finally {
	...
	public static void writeCompressed(NBTTagCompound nBTTagCompound0, OutputStream outputStream1) throws IOException {
		...
		try {
			writeNBT(nBTTagCompound0, dataOutputStream2);
		} finally {
	...
	public static NBTTagCompound readNBT(DataInput dataInput0) throws IOException {
	...
	public static void writeNBT(NBTTagCompound nBTTagCompound0, DataOutput dataOutput1) throws IOException {
