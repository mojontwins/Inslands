...
public class ModelVillager extends ModelBase
{
	...
	// Adapted from r1.4.2 to beta code.
	
	public ModelVillager(float par1) {
		this(par1, 0.0F, 64, 128);
	}

	public ModelVillager(float par1, float par2, int par3, int par4) {		
		this.villagerHead = new ModelRenderer(0,0).setTextureSize(par3, par4);
		this.villagerHead.setRotationPoint(0.0F, 0.0F + par2, 0.0F);
		this.villagerHead.addBox(-4.0F, -10.0F, -4.0F, 8, 10, 8, par1);
				
		this.villagerNose = new ModelRenderer(24, 0).setTextureSize(par3, par4);
		this.villagerNose.setRotationPoint(0.0F, par2 - 2.0F, 0.0F);
		this.villagerNose.addBox(-1.0F, -1.0F, -6.0F, 2, 4, 2, par1);
		this.villagerHead.addChild(this.villagerNose);
		
		this.villagerBody = new ModelRenderer().setTextureSize(par3, par4);
		...
		this.villagerArms = new ModelRenderer().setTextureSize(par3, par4);
		...
		this.rightVillagerLeg = new ModelRenderer(0, 22).setTextureSize(par3, par4);
		this.rightVillagerLeg.setRotationPoint(-2.0F, 12.0F + par2, 0.0F);
		this.rightVillagerLeg.addBox(-2.0F, 0.0F, -2.0F, 4, 12, 4, par1);
		
		this.leftVillagerLeg = new ModelRenderer(0, 22).setTextureSize(par3, par4);
