...
public class ModelAmazon extends ModelBase {
	...
	public ModelAmazon(float f1) {
		this(f1, 0.0F);
	}

	public ModelAmazon(float f1, float f2) {
	...
	public void setLivingAnimations(EntityLiving entityLiving1, float f2, float f3, float f4) {
		EntityAmazon entityAmazon = (EntityAmazon)entityLiving1;
		
		if(entityAmazon.getIsSitting()) {
		...
		this.bipedHead.rotateAngleX = entityAmazon.getInterestedAngle(f4);
	}
