...
public class GuiScreen extends Gui {
	...
	public void drawBackground(int i1) {
		...
		GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.mc.renderEngine.getTexture("/misc/water.png"));
		...
		for(int x = 0; x < this.width; x += 16) {
			...
			//tessellator2.setColorOpaque_I(4210752);
				tessellator2.addVertexWithUV((double)x, (double)(y + 16), 0.0D, d13, d17);
				tessellator2.addVertexWithUV((double)(x + 16), (double)(y + 16), 0.0D, d13, d19);
				tessellator2.addVertexWithUV((double)(x + 16), (double)y, 0.0D, d15, d19);
				tessellator2.addVertexWithUV((double)x, (double)y, 0.0D, d13, d17);
			}
		}
		tessellator2.draw();
		*/
