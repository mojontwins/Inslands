		...
		if(itemstack.itemID < 256 && RenderBlocks.renderItemIn3d(Block.blocksList[itemstack.itemID].getRenderType())) {
			...
			if(num <= 16) {
				...
				if(itemstack.itemID < 256) {
					GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.minecraft.renderEngine.getTexture("/terrain.png"));
					num = Config.getIconWidthTerrain();
				} else {
					GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.minecraft.renderEngine.getTexture("/gui/items.png"));
