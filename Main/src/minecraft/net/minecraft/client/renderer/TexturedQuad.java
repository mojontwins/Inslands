...
public class TexturedQuad {
	...
	public TexturedQuad(PositionTextureVertex[] positionTextureVertex1, int i2, int i3, int i4, int i5) {
		this(positionTextureVertex1, i2, i3, i4, i5, 64, 32);
	}
	
	public TexturedQuad(PositionTextureVertex[] positionTextureVertex1, int i2, int i3, int i4, int i5, float textureWidth, float textureHeight){
		this(positionTextureVertex1);
		float f6 = 0.0015625F;
		float f7 = 0.003125F;
		positionTextureVertex1[0] = positionTextureVertex1[0].setTexturePosition((float)i4 / textureWidth - f6, (float)i3 / textureHeight + f7);
		positionTextureVertex1[1] = positionTextureVertex1[1].setTexturePosition((float)i2 / textureWidth + f6, (float)i3 / textureHeight + f7);
		positionTextureVertex1[2] = positionTextureVertex1[2].setTexturePosition((float)i2 / textureWidth + f6, (float)i5 / textureHeight - f7);
		positionTextureVertex1[3] = positionTextureVertex1[3].setTexturePosition((float)i4 / textureWidth - f6, (float)i5 / textureHeight - f7);
	}
