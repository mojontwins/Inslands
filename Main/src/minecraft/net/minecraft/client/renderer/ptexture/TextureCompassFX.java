...
public class TextureCompassFX extends TextureFX {
	...
	public void onTick() {
		...
		if(this.mc.theWorld != null && this.mc.thePlayer != null) {
			ChunkCoordinates chunkCoordinates21 = this.mc.thePlayer.getPlayerSpawnCoordinate();
			if(chunkCoordinates21 == null) chunkCoordinates21 = this.mc.theWorld.getSpawnPoint();
		...
		double d22;
		for(d22 = d20 - this.currentAngle; d22 < -3.141592653589793D; d22 += Math.PI * 2D) {
		}
		...
		this.angleDelta += d22 * 0.1D;
		this.angleDelta *= 0.8D;
		this.currentAngle += this.angleDelta;
		double d24 = Math.sin(this.currentAngle);
		double d26 = Math.cos(this.currentAngle);
