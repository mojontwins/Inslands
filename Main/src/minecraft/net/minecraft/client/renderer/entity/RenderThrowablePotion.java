...
public class RenderThrowablePotion extends Render {
	...
	public void doRender(Entity entity1, double d2, double d4, double d6, float f8, float f9) {
		...
		ItemPotion itemPotion = ((EntityThrowablePotion)entity1).itemPotion;
		if(itemPotion == null) return;
		
		int i7 = itemPotion.getColorFromDamage(0);
		float r = (float)(i7 >> 16 & 255) / 255.0F;
		float g = (float)(i7 >> 8 & 255) / 255.0F;
		float b = (float)(i7 & 255) / 255.0F;
		float brightness = 1.0F; // entity1.getEntityBrightness(f9);
		GL11.glColor4f(r * brightness, g * brightness, b * brightness, 1.0F);
		
		this.loadTexture("/gui/items.png");
		Tessellator tessellator10 = Tessellator.instance;
		float f11 = (float)(itemPotion.iconIndex % 16 * 16 + 0) / 256.0F;
		float f12 = (float)(itemPotion.iconIndex % 16 * 16 + 16) / 256.0F;
		float f13 = (float)(itemPotion.iconIndex / 16 * 16 + 0) / 256.0F;
		float f14 = (float)(itemPotion.iconIndex / 16 * 16 + 16) / 256.0F;
		float f15 = 1.0F;
		float f16 = 0.5F;
		float f17 = 0.25F;
