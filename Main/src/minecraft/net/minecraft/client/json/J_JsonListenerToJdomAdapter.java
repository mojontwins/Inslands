...
final class J_JsonListenerToJdomAdapter implements J_JsonListener {
	private final Stack<J_NodeContainer> nodeContainersStack = new Stack<J_NodeContainer>();
	...
	public void func_27200_d() {
		...
		this.nodeContainersStack.push(new J_ArrayNodeContainer(this, j_JsonArrayNodeBuilder1));
	}

	public void func_27197_e() {
		this.nodeContainersStack.pop();
	}
	...
	public void func_27194_f() {
		...
		this.nodeContainersStack.push(new J_ObjectNodeContainer(this, j_JsonObjectNodeBuilder1));
	}
	...
	public void func_27205_a(String string1) {
		...
		((J_NodeContainer)this.nodeContainersStack.peek()).func_27289_a(j_JsonFieldBuilder2);
		this.nodeContainersStack.push(new J_FieldNodeContainer(this, j_JsonFieldBuilder2));
	}
	...
	private void func_27206_b(J_JsonNodeBuilder j_JsonNodeBuilder1) {
		((J_NodeContainer)this.nodeContainersStack.peek()).func_27290_a(j_JsonNodeBuilder1);
	}
}
