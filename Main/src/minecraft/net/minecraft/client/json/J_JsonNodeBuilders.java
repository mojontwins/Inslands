...
public final class J_JsonNodeBuilders {
	...
	public static J_JsonNodeBuilder func_27250_a(String string0) {
		return new J_JsonNumberNodeBuilder(string0);
	}

	public static J_JsonStringNodeBuilder func_27254_b(String string0) {
		return new J_JsonStringNodeBuilder(string0);
	}
