...
public final class J_JsonNodeSelectors {
	public static J_JsonNodeSelector aStringNode(Object... object0) {
		return func_27352_a(object0, new J_JsonNodeSelector(new J_JsonStringNodeSelector()));
	}

	public static J_JsonNodeSelector anArrayNode(Object... object0) {
		return func_27352_a(object0, new J_JsonNodeSelector(new J_JsonArrayNodeSelector()));
	}

	public static J_JsonNodeSelector anObjectNode(Object... object0) {
		return func_27352_a(object0, new J_JsonNodeSelector(new J_JsonObjectNodeSelector()));
	}
	
	public static J_JsonNodeSelector aNumberNode(Object... object0) {
		return func_27352_a(object0, new J_JsonNodeSelector(new J_JsonNumberNodeSelector()));
	}

	public static J_JsonNodeSelector func_27348_a(String string0) {
		return aFieldNode(J_JsonNodeFactories.func_27316_a(string0));
	}

	public static J_JsonNodeSelector aFieldNode(J_JsonStringNode j_JsonStringNode0) {
	...
	public static J_JsonNodeSelector func_27351_b(String string0) {
		return anObjectNode(new Object[0]).func_27355_a(func_27348_a(string0));
	}
	...
	public static J_JsonNodeSelector func_27354_b(int i0) {
		return anArrayNode(new Object[0]).func_27355_a(func_27347_a(i0));
	}
