...
public class Item {
	...
	public static Item rottenFlesh = (new ItemFood(1015, 2, true, false)).setIconIndex(5*16 + 11).setItemName("rottenFlesh");
	...
	public static Item amazonFace = new Item(1019).setIconIndex(14*16 + 2);
