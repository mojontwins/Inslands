...
public class Packet60Explosion extends Packet {
	...
	public Packet60Explosion(double d1, double d3, double d5, float f7, Set<ChunkPosition> set8, int blockID) {
		this.explosionX = d1;
		this.explosionY = d3;
		this.explosionZ = d5;
	...
	public void readPacketData(DataInputStream dataInputStream1) throws IOException {
		...
		this.blockID = dataInputStream1.readByte();
	...
	public void writePacketData(DataOutputStream dataOutputStream1) throws IOException {
		...
		dataOutputStream1.writeByte(this.blockID);
