...
public class WorldGenEucalyptusBig extends WorldGenMojon {

	// Original code by smez1234

	public WorldGenEucalyptusBig(boolean withNotify) {
		super(withNotify);
	}

	EnumTreeType tree = EnumTreeType.EUCALYPTUS;
	...
	BlockState trunk = new BlockState(trunkID, trunkMeta);
	BlockState knee = new BlockState(trunkID, trunkMeta & 12);
	BlockState kneeLog = new BlockState(trunkID, trunkMeta);
	BlockState leaves = new BlockState(leavesID, leavesMeta);
