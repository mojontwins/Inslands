...
public class BuildingHut1 extends BuildingOceanRuin {

	public BuildingHut1(World world, boolean rotated) {
		super(world, rotated);
	}
	...
	public void build() {
		...
		this.setBlockColumnRelative(1, 1, new int[] {98, -2, 43, 165 | (1 << 8)});
		...
		this.setBlockColumnRelative(1, 5, new int[] {98, -2, 43, 165 | (1 << 8)});
		...
		this.setBlockColumnRelative(2, 2, new int[] {13, -3, -1, 165 | (1 << 8)});
		this.setBlockColumnRelative(2, 3, new int[] {5, -3, -1, 98});
		this.setBlockColumnRelative(2, 4, new int[] {5, -3, -1, 165 | (1 << 8)});
		...
		this.setBlockColumnRelative(3, 2, new int[] {13, 0, -2, -1, 98});
		this.setBlockColumnRelative(3, 3, new int[] {13, -3, -1, 165 | (1 << 8)});
		this.setBlockColumnRelative(3, 4, new int[] {5, -3, -1, 98});
		...
		this.setBlockColumnRelative(4, 2, new int[] {13, -3, -1, 165 | (1 << 8)});
		this.setBlockColumnRelative(4, 3, new int[] {13, -3, -1, 98});
		this.setBlockColumnRelative(4, 4, new int[] {13, -3, -1, 165 | (1 << 8)});
		this.setBlockColumnRelative(4, 5, new int[] {-4, 98});
		this.setBlockColumnRelative(4, 6, new int[] {13});
		this.setBlockColumnRelative(5, 0, new int[] {13});
		this.setBlockColumnRelative(5, 1, new int[] {98, -2, 43, 165 | (1 << 8)});
		this.setBlockColumnRelative(5, 2, new int[] {-4, 98});
		this.setBlockColumnRelative(5, 3, new int[] {-2, 98, -1, 98});
		this.setBlockColumnRelative(5, 4, new int[] {-4, 98});
		this.setBlockColumnRelative(5, 5, new int[] {98, -2, 43, 165 | (1 << 8)});
