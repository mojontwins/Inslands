...
public class ComponentTFMazeDeadEndShrooms extends ComponentTFMazeDeadEndRoots {
	public ComponentTFMazeDeadEndShrooms(int var1, int var2, int var3, int var4, int var5) {
	...
	public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3, boolean mostlySolid) {
		...
		this.func_74872_a(var1, var3, var7, 1, 4, var7, var5, 4, var4, 10, 0, 0, false);
		this.func_74872_a(var1, var3, var7 - 1, var5, 3, var7 + 1, var5, 4, var4, 14, 0, 0, false);
		return true;
	}
}
