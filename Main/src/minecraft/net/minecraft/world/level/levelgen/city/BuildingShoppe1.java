...
public class BuildingShoppe1 extends Building {
	int y0 = 64;
	
	public BuildingShoppe1(int y0) {
		this.y0 = y0;
	}
	...
	public void generate(int y0, Chunk chunk) {
		...
		data[18816 | y0] = 20;
		data[20864 | y0] = 35;
		meta[10 << 11 | 3 << 7 | y0] = 14;
		data[22912 | y0] = 20;
		data[24960 | y0] = 20;
		data[27008 | y0] = 35;
		meta[13 << 11 | 3 << 7 | y0] = 14;
		data[2560 | y0] = 20;
		data[16896 | y0] = 4;
		data[27136 | y0] = 20;
		data[2688 | y0] = 20;
		...
		data[28032 | y0] = 20;
		data[3584 | y0] = 35;
		meta[1 << 11 | 12 << 7 | y0] = 14;
		data[5632 | y0] = 20;
		data[7680 | y0] = 20;
		data[9728 | y0] = 35;
		meta[4 << 11 | 12 << 7 | y0] = 14;
		data[11776 | y0] = 20;
		data[13824 | y0] = 20;
		data[15872 | y0] = 35;
		meta[7 << 11 | 12 << 7 | y0] = 14;
		data[22016 | y0] = 35;
		meta[10 << 11 | 12 << 7 | y0] = 14;
		data[24064 | y0] = 20;
		data[26112 | y0] = 20;
		data[28160 | y0] = 35;
		meta[13 << 11 | 12 << 7 | y0] = 14;
		y0++;
		data[2432 | y0] = 35;
		meta[1 << 11 | 3 << 7 | y0] = 14;
		data[4480 | y0] = 20;
		...
		meta[7 << 11 | 11 << 7 | y0] = 2;
		data[23936 | y0] = 53;
		meta[11 << 11 | 11 << 7 | y0] = 2;
		data[25984 | y0] = 53;
		meta[12 << 11 | 11 << 7 | y0] = 2;
		data[28032 | y0] = 20;
		data[3584 | y0] = 35;
		meta[1 << 11 | 12 << 7 | y0] = 14;
		data[5632 | y0] = 20;
	...
	public void populate(World world, Random rand, int chunkX, int chunkZ, Chunk chunk) {
		...
		this.addChest(world, rand, x0 + 7, this.y0 + 6, z0 + 9);
		this.addSpawner(world, rand, x0 + 7, this.y0 + 7, z0 + 9, rand.nextBoolean() ? "Spider" : "SwarmSpider");
