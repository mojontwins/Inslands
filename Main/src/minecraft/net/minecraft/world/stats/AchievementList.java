...
public class AchievementList {
	...
	*/
	...
	public static Achievement minoshroom = (new Achievement(61, "minoshroom",      14, -2, Item.leather, themeForest)).setSpecial().registerAchievement();
	...
	public static Achievement superAxe = (new Achievement(67, "superAxe",      16, -2, Item.superAxe, minoshroom)).setSpecial().registerAchievement();
