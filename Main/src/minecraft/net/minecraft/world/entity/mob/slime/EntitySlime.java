package net.minecraft.world.entity.mob.slime;
...
public class EntitySlime extends EntityLiving implements IMob {
	...
	public boolean getCanSpawnHere() {
		...
		return (this.getSlimeSize() == 1 || this.worldObj.difficultySetting > 0) && this.rand.nextInt(10) == 0 && chunk1.getSeededRandom(987234911L).nextInt(10) == 0 && this.posY < 16.0D;
	}
