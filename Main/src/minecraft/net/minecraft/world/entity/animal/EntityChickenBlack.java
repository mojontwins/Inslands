...
public class EntityChickenBlack extends EntityChicken {
	...
	public EntityChickenBlack(World world1) {
		super(world1);
	...
	public boolean attackEntityFrom(Entity entity1, int i2) {
		if(entity1 instanceof EntityPlayer && !((EntityPlayer)entity1).isCreative) {
			...
			List<Entity> list3 = this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.boundingBox.expand(16.0D, 16.0D, 16.0D));

			for(int i4 = 0; i4 < list3.size(); ++i4) {
				Entity entity5 = (Entity)list3.get(i4);
				if(entity5 instanceof EntityChickenBlack) {
					EntityChickenBlack entityToAnger = (EntityChickenBlack)entity5;
