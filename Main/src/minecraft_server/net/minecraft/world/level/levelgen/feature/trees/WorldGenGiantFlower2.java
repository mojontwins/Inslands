...
public class WorldGenGiantFlower2 extends WorldGenBop {
	private final int minTreeHeight;
	private final boolean vinesGrow;

	private static final int bigFlowerId = Block.bigFlower.blockID;

	public WorldGenGiantFlower2() {
		this(2, false);
	}

	public WorldGenGiantFlower2(int var2, boolean var5) {
		this.minTreeHeight = var2;
		this.vinesGrow = var5;
	}

	public boolean generate(World world, Random rand, int x, int y, int z) {
		int var6 = rand.nextInt(12) + this.minTreeHeight;
		boolean var7 = true;
				...
				if ((var8 == Block.grass.blockID || var8 == Block.dirt.blockID) && y < 256 - var6 - 1) {
					...
					for (var10 = 0; var10 < var6; ++var10) {
						...
						if (var11 == 0 || var11 == Block.leaves.blockID) {
							...
							world.setBlockAndMetadata(x, y + var6, z, bigFlowerId, 1);
							world.setBlockAndMetadata(x - 1, y + var6, z, bigFlowerId, 1);
							world.setBlockAndMetadata(x + 1, y + var6, z, bigFlowerId, 1);
							world.setBlockAndMetadata(x, y + var6, z - 1, bigFlowerId, 1);
							world.setBlockAndMetadata(x, y + var6, z + 1, bigFlowerId, 1);
							world.setBlockAndMetadata(x - 1, y + var6, z - 1, bigFlowerId, 1);
							world.setBlockAndMetadata(x - 1, y + var6, z + 1, bigFlowerId, 1);
							world.setBlockAndMetadata(x + 1, y + var6, z - 1, bigFlowerId, 1);
							world.setBlockAndMetadata(x + 1, y + var6, z + 1, bigFlowerId, 1);
							world.setBlockAndMetadata(x - 1, y + var6, z - 2, bigFlowerId, 1);
							world.setBlockAndMetadata(x - 1, y + var6, z + 2, bigFlowerId, 1);
							world.setBlockAndMetadata(x + 1, y + var6, z - 2, bigFlowerId, 1);
							world.setBlockAndMetadata(x + 1, y + var6, z + 2, bigFlowerId, 1);
							world.setBlockAndMetadata(x - 2, y + var6, z - 1, bigFlowerId, 1);
							world.setBlockAndMetadata(x - 2, y + var6, z + 1, bigFlowerId, 1);
							world.setBlockAndMetadata(x + 2, y + var6, z - 1, bigFlowerId, 1);
							world.setBlockAndMetadata(x + 2, y + var6, z + 1, bigFlowerId, 1);
