...
public class MapGenRavine extends MapGenBase {
                            ...
                            if(
                                ...
                                if (i3 < 10) {
                                    ...
                                    if (flag2 && par5ArrayOfByte[l2 - 1] == Block.dirt.blockID) {
                                        par5ArrayOfByte[l2 - 1] = par1World.getWorldChunkManager().getBiomeGenAt(k1 + par3 * 16, k2 + par4 * 16).topBlock;
                                    }
                                }
                            }
                        }
    ...
    protected void recursiveGenerate(World par1World, int par2, int par3, int par4, int par5, byte par6ArrayOfByte[]) {
        ...
        double d1 = rand.nextInt(rand.nextInt(60) + 8) + 20;
        ...
        for (int j = 0; j < i; j++) {       	
            ...
            generateRavine(par1World, rand.nextLong(), par4, par5, par6ArrayOfByte, d, d1, d2, f2, f, f1, 0, 0, 3D);
        }
    }
}
