...
public class WorldGenBigTreeDead extends WorldGenerator {
				...
				while(true) {
					...
					if(d15 > (double)f4) {
						...
						if(i14 != 0 && i14 != Block.leaves.blockID) {
							...
							this.world.setBlock(i11[0], i11[1], i11[2], i6);
							++i13;
						}
					}
				}
	...
	void generateLeafNode(int x, int y, int z) {
		...
		for(int i5 = y + this.leafDistanceLimit; i4 < i5; ++i4) {
			...
			this.genTreeLayer(x, i4, z, f6, (byte)1, Block.leaves.blockID);
		}
