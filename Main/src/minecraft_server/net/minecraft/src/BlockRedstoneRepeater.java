...
public class BlockRedstoneRepeater extends Block {
	...
	public void updateTick(World world1, int i2, int i3, int i4, Random random5) {
		...
		boolean z7 = this.ignoreTick(world1, i2, i3, i4, i6);
	...
	private boolean ignoreTick(World world1, int i2, int i3, int i4, int i5) {
		int i6 = i5 & 3;
		switch(i6) {
		case 0:
	...
	public void randomDisplayTick(World world1, int i2, int i3, int i4, Random random5) {
		if(this.isRepeaterPowered) {
			...
			if(random5.nextInt(2) == 0) {
				...
				switch(i6 & 3) {
				case 0:
					d15 = repeaterTorchOffset[i17];
					break;
				case 1:
					d13 = -repeaterTorchOffset[i17];
					break;
				case 2:
					d15 = -repeaterTorchOffset[i17];
					break;
