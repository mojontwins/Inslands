...
public class InventoryBasic implements IInventory {
	...
	private List<IInvBasic> unusedInventoryList;
	...
	public void onInventoryChanged() {
		if(this.unusedInventoryList != null) {
			for(int i1 = 0; i1 < this.unusedInventoryList.size(); ++i1) {
				((IInvBasic)this.unusedInventoryList.get(i1)).onInventoryChanged(this);
			}
		}
