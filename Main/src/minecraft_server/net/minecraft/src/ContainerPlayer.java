...
public class ContainerPlayer extends Container {
	...
	public ItemStack getStackInSlot(int i1) {
		...
		if(slot3 != null && slot3.getHasStack()) {
			...
			if(i1 == 0) {
				this.mergeItemStack(itemStack4, 9, 45, true);
			} else if(i1 >= 9 && i1 < 36) {
				this.mergeItemStack(itemStack4, 36, 45, false);
			} else if(i1 >= 36 && i1 < 45) {
				this.mergeItemStack(itemStack4, 9, 36, false);
			} else {
				this.mergeItemStack(itemStack4, 9, 45, false);
			}
