...
import net.minecraft.src.Packet96BadMoonDecide;
import net.minecraft.src.Packet98UpdateWeather;
...
public class WorldServer extends World {
	...
	protected void updateWeather() {
		boolean snowing = this.worldInfo.getSnowing();
		boolean raining = this.worldInfo.getRaining();
		boolean thundering = this.worldInfo.getThundering();
