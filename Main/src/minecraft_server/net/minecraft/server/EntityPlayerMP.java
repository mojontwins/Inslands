...
import net.minecraft.src.Packet94FreezeLevel;
...
public class EntityPlayerMP extends EntityPlayer implements ICrafting {
		...
		if(this.ticksOfInvuln > 0) {
			...
			if(!this.mcServer.pvpOn) {
				...
				if(entity1 instanceof EntityArrow) {
					...
					if(entityArrow3.shootingEntity instanceof EntityPlayer) {
						return false;
					}
				}
			}
	...
	public void s_func_28017_a(Container container1) {
		this.updateCraftingInventory(container1, container1.getInventoryStacks());
	}
