...
import com.mojontwins.minecraft.amazonvillage.FeatureAmazonVillage;
import com.mojontwins.minecraft.fossils.FeatureFossil;
...
public class FeatureProvider {
	...
	public Feature getFeatureForChunkCoords(int chunkX, int chunkZ) {
		...
		feature.setup(world, rand, biome, chunkX, chunkZ);
