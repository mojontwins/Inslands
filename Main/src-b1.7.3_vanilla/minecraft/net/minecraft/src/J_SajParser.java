...
public final class J_SajParser {
	...
	private void func_27455_a(J_PositionTrackingPushbackReader j_PositionTrackingPushbackReader1, J_JsonListener j_JsonListener2) throws IOException, J_InvalidSyntaxException {
	...
	private void func_27453_b(J_PositionTrackingPushbackReader j_PositionTrackingPushbackReader1, J_JsonListener j_JsonListener2) throws IOException, J_InvalidSyntaxException {
		char c3 = (char)this.func_27448_l(j_PositionTrackingPushbackReader1);
		if(c3 != 123) {
			throw new J_InvalidSyntaxException("Expected object to start with { but got [" + c3 + "].", j_PositionTrackingPushbackReader1);
		} else {
	...
	private void func_27449_c(J_PositionTrackingPushbackReader j_PositionTrackingPushbackReader1, J_JsonListener j_JsonListener2) throws IOException, J_InvalidSyntaxException {
		char c3 = (char)this.func_27448_l(j_PositionTrackingPushbackReader1);
		if(34 != c3) {
	...
	private void func_27464_d(J_PositionTrackingPushbackReader j_PositionTrackingPushbackReader1, J_JsonListener j_JsonListener2) throws IOException, J_InvalidSyntaxException {
		char c3 = (char)this.func_27448_l(j_PositionTrackingPushbackReader1);
		switch(c3) {
		case '\"':
			j_PositionTrackingPushbackReader1.func_27334_a(c3);
