...
public class GuiMultiplayer extends GuiScreen {
	...
	public void initGui() {
		...
		this.tbServerAddress = new GuiTextField(this, this.fontRenderer, this.width / 2 - 100, this.height / 4 - 10 + 50 + 18, 200, 20, string2);
	...
	protected void actionPerformed(GuiButton guiButton1) {
		if(guiButton1.enabled) {
			if(guiButton1.id == 1) {
				...
				String string2 = this.tbServerAddress.getText().trim();
	...
	protected void keyTyped(char c1, int i2) {
		this.tbServerAddress.textboxKeyTyped(c1, i2);
		if(c1 == 13) {
	...
	protected void mouseClicked(int i1, int i2, int i3) {
		...
		this.tbServerAddress.mouseClicked(i1, i2, i3);
	}
