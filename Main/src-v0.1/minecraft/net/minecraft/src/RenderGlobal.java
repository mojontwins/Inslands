...
public class RenderGlobal implements IWorldAccess {
	...
	public void renderSky(float f1) {
		if(!this.mc.theWorld.worldProvider.isNether) {
			...
			*/
			...
			GL11.glPushMatrix();
			f7 = (1.0F - this.worldObj.getRainStrength(f1)) * LevelThemeGlobalSettings.lightMultiplier;
			f8 = 0.0F;
			f9 = 0.0F;
			f10 = 0.0F;
	...
	public void renderCloudsFancy(float f1) {
		...
		GL11.glEnable(GL11.GL_BLEND);
		GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
		Vec3D vec3D13 = this.worldObj.getCloudColor(f1, this.mc.renderViewEntity);
	...
	public boolean updateRenderers(EntityLiving entityLiving1, boolean z2) {
		...
		if(z3) {
			...
			for(i10 = 0; i10 < i8; ++i10) {
				...
				this.worldRenderersToUpdate.set(i10, (WorldRenderer)null);
			}
