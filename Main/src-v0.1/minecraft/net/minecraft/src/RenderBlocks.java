...
public class RenderBlocks {
	...
	public boolean renderBlockByRenderType(Block block, int x, int y, int z) {
		...
		return i5 == 0 ? this.renderStandardBlock(block1, i2, i3, i4) : (i5 == 4 ? this.renderBlockFluids(block1, i2, i3, i4) : (i5 == 13 ? this.renderBlockCactus(block1, i2, i3, i4) : (i5 == 1 ? this.renderBlockReed(block1, i2, i3, i4) : (i5 == 6 ? this.renderBlockCrops(block1, i2, i3, i4) : (i5 == 2 ? this.renderBlockTorch(block1, i2, i3, i4) : (i5 == 3 ? this.renderBlockFire(block1, i2, i3, i4) : (i5 == 5 ? this.renderBlockRedstoneWire(block1, i2, i3, i4) : (i5 == 8 ? this.renderBlockLadder(block1, i2, i3, i4) : (i5 == 7 ? this.renderBlockDoor(block1, i2, i3, i4) : (i5 == 9 ? this.renderBlockrail((BlockRail)block1, i2, i3, i4) : (i5 == 10 ? this.renderBlockStairs(block1, i2, i3, i4) : (i5 == 11 ? this.renderBlockFence(block1, i2, i3, i4) : (i5 == 12 ? this.renderBlockLever(block1, i2, i3, i4) : (i5 == 14 ? this.renderBlockBed(block1, i2, i3, i4) : (i5 == 15 ? this.renderBlockRepeater(block1, i2, i3, i4) : (i5 == 16 ? this.func_31074_b(block1, i2, i3, i4, false) : (i5 == 17 ? this.func_31080_c(block1, i2, i3, i4, true) : false)))))))))))))))));
		*/
	...
	public boolean renderStandardBlockWithAmbientOcclusion(Block block1, int i2, int i3, int i4, float f5, float f6, float f7) {
		...
		boolean z17 = true;
		boolean z18 = true;
		this.lightValueOwn = block1.getBlockBrightness(this.blockAccess, i2, i3, i4);
	...
	public boolean renderBlockVine(Block block, int i, int j, int k) {
		...
		tessellator.setColorOpaque_F(var8 * f, var9 * f, var10 * f);
	...
	public boolean renderBlockLilypad(Block block, int x, int y, int z) {
		...
		if((i1 & 4) != 0) {
			...
			this.renderBlockReed(block, x, y, z);
			this.overrideBlockTexture = -1;
		}
	...
	public boolean renderBlockSlime(Block block, int x, int y, int z) {
		...
		if(this.activeRenderPass == 0) {
			...
			// Block texture is the outer translucent box, use this to
			// change to a different texture to render the inner box
			this.overrideBlockTexture = 12 * 16 + 4;
			
			// Render inner box
			boolean wasRendered = this.renderStandardBlock(block, x, y, z);
			
			// Deactivate overrideBlockTexture
			this.overrideBlockTexture = -1;
	...
	public static boolean renderItemIn3d(int i0) {
		...
		return (i0 == 0 || i0 == 13 || i0 == 10 || i0 == 11 || i0 == 16 || (i0 >= 102 && i0 <= 109));
	}
}
