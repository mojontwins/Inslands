...
public class NetClientHandler extends NetHandler {
	...
	public void handleLogin(Packet1Login packet1Login1) {
		...
		this.worldClient = new WorldClient(this, new WorldSettings(0L, 0, false, false, WorldType.DEFAULT), packet1Login1.dimension);
	...
	public void handleVehicleSpawn(Packet23VehicleSpawn packet23VehicleSpawn1) {
		...
		switch(packet23VehicleSpawn1.type) {
			...
			case 61:
				...
				break;
			case 63:
				object8 = new EntityFireball(this.worldClient, d2, d4, d6, (double)packet23VehicleSpawn1.motionXencoded / 8000.0D, (double)packet23VehicleSpawn1.motionYencoded / 8000.0D, (double)packet23VehicleSpawn1.motionZencoded / 8000.0D);
			...
			case 100:
				object8 = new EntityPebble(this.worldClient, d2, d4, d6);
				break;
		}
		...
		if(object8 != null) {
			...
			if(packet23VehicleSpawn1.throwerEntityId > 0) {
				...
				((Entity)object8).setVelocity((double)packet23VehicleSpawn1.motionXencoded / 8000.0D, (double)packet23VehicleSpawn1.motionYencoded / 8000.0D, (double)packet23VehicleSpawn1.motionZencoded / 8000.0D);
			}
		}
