...
public class EntityRenderer {
	...
	protected void renderRainSnow(float f1) {
		...
		if(f2 > 0.0F) {
			...
			BiomeGenBase[] biomeGenBase17 = world4.getWorldChunkManager().getBiomesForGeneration(i5 - b16, i7 - b16, b16 * 2 + 1, b16 * 2 + 1);
			int i18 = 0;
			...
			for(i19 = i5 - b16; i19 <= i5 + b16; ++i19) {
				for(i20 = i7 - b16; i20 <= i7 + b16; ++i20) {
					...
					if(biomeGenBase21.getEnableSnow()) {
						i22 = world4.findTopSolidBlockUsingBlockMaterial(i19, i20);
						if(i22 < 0) {
							i22 = 0;
						}
	...
	private void updateFogColor(float f1) {
		...
		Vec3D vec3D9 = world2.getFogColor(f1, this.mc.renderViewEntity);
