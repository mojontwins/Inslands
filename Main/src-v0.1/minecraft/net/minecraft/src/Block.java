...
public class Block {
	...
	public static final Block stone = (new BlockStone(1, 1)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("stone").setIsUrban(true);
	...
	public static final Block cobblestone = (new Block(4, 16, Material.rock)).setHardness(2.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("stonebrick").setIsUrban(true);
	...
	public static final Block brick = (new Block(45, 7, Material.rock)).setHardness(2.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("brick").setIsUrban(true);
	...
	public static final Block cobblestoneMossy = (new Block(48, 36, Material.rock)).setHardness(2.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("stoneMoss").setIsUrban(true);
	...
	public static final Block stoneBricks = (new Block(98, 14*16 + 5, Material.rock)).setHardness(2.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setIsUrban(true);
	public static final Block mushroomCapBrown = (new BlockBigMushroom(99, 1)).setHardness(0.2F).setStepSound(soundWoodFootstep);
	public static final Block mushroomCapRed = (new BlockBigMushroom(100, 0)).setHardness(0.2F).setStepSound(soundWoodFootstep);
	public static final Block vine = (new BlockVine(106, 13*16 + 12)).setHardness(0.2F).setStepSound(soundGrassFootstep);
	public static final Block mycelium = (new BlockMycelium(110)).setHardness(0.6F).setStepSound(soundGrassFootstep);
	public static final Block lilyPad = (BlockLilypad)(new BlockLilypad(111, 13*16 + 11)).setHardness(0.3F).setStepSound(soundGrassFootstep);	
	public static final Block cryingObsidian = (new BlockCryingObsidian(114, 116)).setHardness(10.0F).setResistance(2000.0F).setStepSound(soundStoneFootstep);
	
	// Custom *new* blocks ID >= 128
	public static final Block ironWall = (new BlockWall(128, 14*16 + 12)).setHardness(2.5F).setResistance(5.0F).setStepSound(soundMetalFootstep);
	public static final Block woodenSpikes = (new BlockWoodenSpikes(129, 14*16 + 11)).setHardness(2.0F).setResistance(1.0F).setStepSound(soundWoodFootstep);
	public static final Block streetLantern = (new BlockStreetLantern(130, 14*16 + 9, false)).setHardness(0.5F).setStepSound(soundMetalFootstep).setLightValue(0.875F).setIsUrban(true);
	public static final Block streetLanternBroken = (new BlockStreetLantern(131, 14*16 + 9, true)).setHardness(0.5F).setStepSound(soundMetalFootstep).setIsUrban(true);
	public static final Block streetLanternFence = (new BlockFence(132, 14*16 + 7, Material.iron)).setHardness(2.0F).setResistance(5.0F).setStepSound(soundMetalFootstep);
	...
	public static final Block layeredSand = (new BlockLayeredSand(134, 18)).setHardness(0.2F).setStepSound(soundSandFootstep);
	public static final Block hollowLog = (new BlockHollowLog(135,20)).setHardness(1.0F).setResistance(1.0F).setStepSound(soundWoodFootstep);
	public static final Block dirtPath = (new BlockDirtPath(136, 13*16 + 6)).setHardness(0.6F).setStepSound(soundGrassFootstep);
	public static final Block blockCoal = (new Block(137, 14*16 + 4, Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep);
	public static final Block regolith = (new BlockRegolith(138, 13*16 + 5)).setHardness(0.7F).setStepSound(soundGravelFootstep);
	public static final Block glowshroom = (new BlockMushroom(139, 13*16 + 4)).setHardness(0.0F).setStepSound(soundGrassFootstep).setLightValue(0.5F);
	public static final Block oreRuby = (new BlockOre(140, 14*16 + 3)).setHardness(2.5F).setResistance(10.0F).setStepSound(soundStoneFootstep);
	public static final Block oreEmerald = (new BlockOre(141, 13*16 + 3)).setHardness(2.5F).setResistance(10.0F).setStepSound(soundStoneFootstep);
	public static final Block seaweed = (new BlockSeaweed(142, 15*16 + 12)).setHardness(0.2F).setLightOpacity(3).setStepSound(soundGrassFootstep);
	public static final BlockFlower paeonia = (BlockFlower)(new BlockFlower(143, 14*16 + 2)).setHardness(0.0F).setStepSound(soundGrassFootstep);
	public static final BlockFlower blueFlower = (BlockFlower)(new BlockFlower(144, 14*16 + 0)).setHardness(0.0F).setStepSound(soundGrassFootstep);
	public static final Block coral = (new BlockCoral(145, 12 * 16 + 10)).setHardness(0.5F).setStepSound(soundGrassFootstep).setLightOpacity(3).setLightValue(0.675F);
	public static final Block mushroomCapGreen = (new BlockBigMushroom(146, 2)).setHardness(0.2F).setStepSound(soundWoodFootstep).setLightValue(0.675F);
	public static final Block shinyGlass = (new Block(147, 12 * 16 + 8, Material.glass)).setHardness(0.3F).setStepSound(soundGlassFootstep).setIsUrban(true).setLightValue(1.0F);
	public static final Block chippedWood = (new BlockChippedWood(148, 13 * 16 + 9)).setHardness(1.8F).setStepSound(soundWoodFootstep);
	public static final Block driedKelpBlock = (new Block(149, 12 * 16 + 7, Material.grass)).setHardness(0.5F).setStepSound(soundGrassFootstep);
	// public static final Block mazeStone = (new BlockTFMazestone(150, 14*16 + 5)).setHardness(15.0F).setResistance(5.0F).setStepSound(soundMetalFootstep);
	public static final Block mobSpawnerOneshot = (new BlockMobSpawner(151, 65, true)).setHardness(5.0F).setStepSound(soundMetalFootstep);
	public static final Block slimeBlock = (new BlockSlime(152, 12 * 16 + 6, Material.slime)).setHardness(0.2F).setStepSound(soundSlimeFootstep).setSliperiness(0.8F);
	public static final Block adobe = (new BlockAdobe(153, 12 * 16 + 5)).setHardness(0.7F).setStepSound(soundGrassFootstep);
	public static final Block bigFlower = (new BlockBigFlower(154, 11 * 16 + 13, Material.leaves)).setHardness(0.5F).setStepSound(soundWoodFootstep);
	public static final Block fleshBlock = (new BlockMeat(155, 103, Material.flesh)).setHardness(0.5F).setStepSound(soundSandFootstep);
	public static final Block hayStack = (new BlockHaystack(156, 11 * 16 + 11)).setHardness(0.5F).setStepSound(soundGrassFootstep);
	public static final Block oreGlow = (new BlockRedstoneOre(157, 11 * 16 + 10, false, 1)).setHardness(1.5F).setLightValue(0.375F).setStepSound(soundStoneFootstep);
	public static final Block oreGlowGlowing = (new BlockRedstoneOre(158, 11 * 16 + 10, true, 1)).setHardness(1.5F).setLightValue(1.0F).setStepSound(soundStoneFootstep);
