...
public class ComponentMineshaftCross extends StructureComponent {
	...
	public boolean addComponentParts(World world1, Random random2, StructureBoundingBox structureBoundingBox3, boolean mostlySolid) {
		if(this.isLiquidInStructureBoundingBox(world1, structureBoundingBox3)) {
			...
			// Columns
			this.fillWithBlocksWithRandomVariation(world1, structureBoundingBox3, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.minZ + 1, this.boundingBox.minX + 1, this.boundingBox.maxY, this.boundingBox.minZ + 1, Block.wood.blockID, Block.chippedWood.blockID, random2, 4, false);
			this.fillWithBlocksWithRandomVariation(world1, structureBoundingBox3, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.maxZ - 1, this.boundingBox.minX + 1, this.boundingBox.maxY, this.boundingBox.maxZ - 1, Block.wood.blockID, Block.chippedWood.blockID, random2, 4, false);
			this.fillWithBlocksWithRandomVariation(world1, structureBoundingBox3, this.boundingBox.maxX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, this.boundingBox.maxX - 1, this.boundingBox.maxY, this.boundingBox.minZ + 1, Block.wood.blockID, Block.chippedWood.blockID, random2, 4, false);
			this.fillWithBlocksWithRandomVariation(world1, structureBoundingBox3, this.boundingBox.maxX - 1, this.boundingBox.minY, this.boundingBox.maxZ - 1, this.boundingBox.maxX - 1, this.boundingBox.maxY, this.boundingBox.maxZ - 1, Block.wood.blockID, Block.chippedWood.blockID, random2, 4, false);
