...
public class BlockDispenser extends BlockContainer {
	...
	private void dispenseItem(World world1, int i2, int i3, int i4, Random random5) {
		...
		if(itemStack12 == null) {
			world1.func_28106_e(1001, i2, i3, i4, 0);
		} else {
			if(itemStack12.itemID == Item.arrow.shiftedIndex) {
				...
				world1.func_28106_e(1002, i2, i3, i4, 0);
				...
				entitySnowball23.setSnowballHeading((double)b9, (double)0.1F, (double)b10, 1.1F, 6.0F);
				...
				world1.func_28106_e(1000, i2, i3, i4, 0);
			}

			world1.func_28106_e(2000, i2, i3, i4, b9 + 1 + (b10 + 1) * 3);
		}
