...
public class AetherAchievements {
	...
	public AetherAchievements() {
		enterAether = (new Achievement(800, "enterAether", 0, 0, Block.glowStone, (Achievement)null)).registerAchievement();
		defeatBronze = (new Achievement(801, "defeatBronze", -2, 3, new ItemStack(AetherItems.Key, 1, 0), enterAether)).registerAchievement();
		defeatSilver = (new Achievement(802, "defeatSilver", 0, 4, new ItemStack(AetherItems.Key, 1, 1), enterAether)).registerAchievement();
		defeatGold = (new Achievement(803, "defeatGold", 2, 3, new ItemStack(AetherItems.Key, 1, 2), enterAether)).registerAchievement();
		enchanter = (new Achievement(804, "enchanter", 2, 1, AetherBlocks.Enchanter, enterAether)).registerAchievement();
		incubator = (new Achievement(805, "incubator", 2, -1, AetherBlocks.Incubator, enterAether)).registerAchievement();
		blueCloud = (new Achievement(806, "blueCloud", -2, -1, new ItemStack(AetherBlocks.Aercloud, 1, 1), enterAether)).registerAchievement();
		flyingPig = (new Achievement(807, "flyingPig", -2, 1, Item.saddle, enterAether)).registerAchievement();
		gravTools = (new Achievement(808, "gravTools", -1, -3, AetherItems.PickGravitite, enterAether)).registerAchievement();
