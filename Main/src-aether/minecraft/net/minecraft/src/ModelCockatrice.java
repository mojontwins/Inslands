...
public class ModelCockatrice extends ModelBase {
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5) {
		...
		this.legs2.rotateAngleX = MathHelper.cos(f * 0.6662F + 3.141593F) * 1.4F * f1;
		if(f2 > 0.001F) {
