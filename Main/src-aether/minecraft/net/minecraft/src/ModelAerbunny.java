...
public class ModelAerbunny extends ModelBase {
	...
	public ModelAerbunny() {
		...
		this.h2 = new ModelRenderer(20, 0);
		...
		this.b3 = new ModelRenderer(29, 0);
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5) {
		...
		this.ff1.rotateAngleX = MathHelper.cos(f * 0.6662F + 3.141593F) * 1.2F * f1;
		this.e2.rotateAngleX = MathHelper.cos(f * 0.6662F) * 1.0F * f1;
		this.ff2.rotateAngleX = MathHelper.cos(f * 0.6662F + 3.141593F) * 1.2F * f1;
	}
}
