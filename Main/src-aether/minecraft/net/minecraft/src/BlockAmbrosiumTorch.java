...
public class BlockAmbrosiumTorch extends Block {
	protected BlockAmbrosiumTorch(int blockID) {
		super(blockID, ModLoader.addOverride("/terrain.png", "/aether/blocks/AmbrosiumTorch.png"), Material.circuits);
	...
	public boolean canPlaceBlockAt(World world, int i, int j, int k) {
		return world.isBlockOpaqueCube(i - 1, j, k) ? true : (world.isBlockOpaqueCube(i + 1, j, k) ? true : (world.isBlockOpaqueCube(i, j, k - 1) ? true : (world.isBlockOpaqueCube(i, j, k + 1) ? true : world.isBlockOpaqueCube(i, j - 1, k))));
	}
