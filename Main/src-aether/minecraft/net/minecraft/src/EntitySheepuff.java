...
public class EntitySheepuff extends EntityAetherAnimal {
	...
	public EntitySheepuff(World world) {
		super(world);
		this.texture = "/aether/mobs/sheepuff.png";
	...
	public boolean interact(EntityPlayer entityplayer) {
		...
		if(itemstack != null && itemstack.itemID == Item.dyePowder.shiftedIndex && !this.getSheared()) {
			colour = BlockCloth.func_21034_c(itemstack.getItemDamage());
	...
	public void onUpdate() {
		...
		if(this.rand.nextInt(100) == 0) {
			...
			if(this.worldObj.getBlockId(x, y - 1, z) == AetherBlocks.Grass.blockID) {
				this.worldObj.setBlockWithNotify(x, y - 1, z, AetherBlocks.Dirt.blockID);
				++this.amountEaten;
			}
		}
