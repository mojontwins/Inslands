...
public class ModelAechorPlant extends ModelBase {
	...
	public ModelAechorPlant(float f, float f1) {
		...
		int i;
		for(i = 0; i < petals; ++i) {
			this.petal[i] = new ModelRenderer(0, 0);
			if(i % 2 == 0) {
				this.petal[i] = new ModelRenderer(29, 3);
			...
			this.leaf[i] = new ModelRenderer(38, 13);
