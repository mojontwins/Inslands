...
public class GuiLore extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer() {
		...
		this.fontRenderer.drawString("Volume " + (this.type + 1), 47, 28, 4210752);
		switch(this.type) {
		case 0:
			this.fontRenderer.drawString("The Surface", 37, 38, 4210752);
			break;
		case 1:
		...
		if(item != null) {
			...
			while(i$.hasNext()) {
				...
				if(lore.equals(item) && lore.type == this.type) {
					...
					if(item.itemID == AetherItems.LoreBook.shiftedIndex) {
	...
	protected void drawGuiContainerBackgroundLayer(float f) {
		this.xSize = 256;
		this.ySize = 195;
		int i = this.mc.renderEngine.getTexture("/aether/gui/lore.png");
