...
public class BlockPistonBase extends Block {
	...
	public int getBlockTextureFromSideAndMetadata(int i1, int i2) {
		...
		return i3 > 5 ? this.blockIndexInTexture : (i1 == i3 ? (!isPowered(i2) && this.minX <= 0.0D && this.minY <= 0.0D && this.minZ <= 0.0D && this.maxX >= 1.0D && this.maxY >= 1.0D && this.maxZ >= 1.0D ? this.blockIndexInTexture : 110) : (i1 == PistonBlockTextures.faceToSide[i3] ? 109 : 108));
	}
	...
	public void playBlock(World world1, int i2, int i3, int i4, int i5, int i6) {
		...
		if(i5 == 0) {
			...
			TileEntity tileEntity8 = world1.getBlockTileEntity(i2 + PistonBlockTextures.offsetsXForSide[i6], i3 + PistonBlockTextures.offsetsYForSide[i6], i4 + PistonBlockTextures.offsetsZForSide[i6]);
			...
			if(this.isSticky) {
				int i9 = i2 + PistonBlockTextures.offsetsXForSide[i6] * 2;
				int i10 = i3 + PistonBlockTextures.offsetsYForSide[i6] * 2;
				int i11 = i4 + PistonBlockTextures.offsetsZForSide[i6] * 2;
				...
				if(i12 == Block.pistonMoving.blockID) {
					...
					if(tileEntity15 != null && tileEntity15 instanceof TileEntityPiston) {
						...
						if(tileEntityPiston16.getOrientation() == i6 && tileEntityPiston16.getExtending()) {
				...
				if(z14 || i12 <= 0 || !canPushBlock(i12, world1, i9, i10, i11, false) || Block.blocksList[i12].getMobilityFlag() != 0 && i12 != Block.pistonBase.blockID && i12 != Block.pistonStickyBase.blockID) {
					if(!z14) {
						...
						world1.setBlockWithNotify(i2 + PistonBlockTextures.offsetsXForSide[i6], i3 + PistonBlockTextures.offsetsYForSide[i6], i4 + PistonBlockTextures.offsetsZForSide[i6], 0);
						this.ignoreUpdates = true;
					}
				} else {
					this.ignoreUpdates = false;
	...
	private static boolean canExtend(World world0, int i1, int i2, int i3, int i4) {
		int i5 = i1 + PistonBlockTextures.offsetsXForSide[i4];
	...
	private boolean tryExtend(World world1, int i2, int i3, int i4, int i5) {
		int i6 = i2 + PistonBlockTextures.offsetsXForSide[i5];
		int i7 = i3 + PistonBlockTextures.offsetsYForSide[i5];
		int i8 = i4 + PistonBlockTextures.offsetsZForSide[i5];
		int i9 = 0;
			...
			if(i7 > 0 && i7 < 127) {
				...
				if(i10 != 0) {
					...
					if(Block.blocksList[i10].getMobilityFlag() != 1) {
						...
						i6 += PistonBlockTextures.offsetsXForSide[i5];
						i7 += PistonBlockTextures.offsetsYForSide[i5];
						i8 += PistonBlockTextures.offsetsZForSide[i5];
						++i9;
						continue;
					}
		...
		while(i6 != i2 || i7 != i3 || i8 != i4) {
			i9 = i6 - PistonBlockTextures.offsetsXForSide[i5];
			i10 = i7 - PistonBlockTextures.offsetsYForSide[i5];
			int i11 = i8 - PistonBlockTextures.offsetsZForSide[i5];
			int i12 = world1.getBlockId(i9, i10, i11);
			int i13 = world1.getBlockMetadata(i9, i10, i11);
