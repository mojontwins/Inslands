...
public class NoiseGeneratorOctaves2 extends NoiseGenerator {
	...
	public double[] generateNoiseOctaves(double[] var1, double var2, double var4, int var6, int var7, double var8, double var10, double var12) {
		return this.generateNoiseOctaves(var1, var2, var4, var6, var7, var8, var10, var12, 0.5D);
	}

	public double[] generateNoiseOctaves(double[] var1, double var2, double var4, int var6, int var7, double var8, double var10, double var12, double var14) {
		var8 /= 1.5D;
		var10 /= 1.5D;
