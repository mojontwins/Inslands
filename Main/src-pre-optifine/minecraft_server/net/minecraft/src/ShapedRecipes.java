	...
	private boolean checkMatch(InventoryCrafting inventoryCrafting1, int i2, int i3, boolean z4) {
		for(int i5 = 0; i5 < 3; ++i5) {
			for(int i6 = 0; i6 < 3; ++i6) {
				...
				ItemStack itemStack10 = ItemStack.copyItemStack(inventoryCrafting1.getStackInRowAndColumn(i5, i6));
				if(itemStack10 != null && itemStack10.itemID == Block.cobblestoneMossy.blockID) itemStack10.itemID = Block.cobblestone.blockID;
