...
public class GuiAchievement extends Gui {
	...
	public void queueTakenAchievement(Achievement achievement1) {
		...
		this.achievementStatName = achievement1.statName;
	...
	public void queueAchievementInformation(Achievement achievement1) {
		this.achievementGetLocalText = achievement1.statName;
	...
	public void updateAchievementWindow() {
		...
		*/
		...
		if(this.theAchievement != null && this.achievementTime != 0L) {
			double d8 = (double)(System.currentTimeMillis() - this.achievementTime) / 3000.0D;
			if(this.haveAchievement || d8 >= 0.0D && d8 <= 1.0D) {
				this.updateAchievementWindowScale();
				GL11.glDisable(GL11.GL_DEPTH_TEST);
				GL11.glDepthMask(false);
				double d9 = d8 * 2.0D;
