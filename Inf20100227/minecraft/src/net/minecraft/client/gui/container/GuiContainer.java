	...
	public void drawScreen(int var1, int var2, float var3) {
		...
		for(int var5 = 0; var5 < this.inventorySlots.size(); ++var5) {
			...
			label24: {
				...
				itemRenderer.doRender(this.mc.renderEngine, var15, var11, var12);
		...
		if(this.itemStack != null) {
			...
			itemRenderer.doRender(this.mc.renderEngine, this.itemStack, var1 - var13 - 8, var2 - var4 - 8);
		...
		GL11.glDisable(GL11.GL_LIGHTING);
		GL11.glDisable(GL11.GL_DEPTH_TEST);
		this.guiCraftingItemsCheck();
		GL11.glEnable(GL11.GL_LIGHTING);
		GL11.glEnable(GL11.GL_DEPTH_TEST);
		GL11.glPopMatrix();
	}

	protected void guiCraftingItemsCheck() {
	}
