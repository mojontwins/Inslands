...
public final class EffectRenderer {
	...
	public final void addBlockHitEffects(int var1, int var2, int var3, int var4) {
		...
		if(var5 != 0) {
			Block var11 = Block.blocksList[var5];
			float var6 = (float)var1 + this.rand.nextFloat() * (var11.maxX - var11.minX - 0.2F) + 0.1F + var11.minX;
			float var7 = (float)var2 + this.rand.nextFloat() * (var11.maxY - var11.minY - 0.2F) + 0.1F + var11.minY;
			float var8 = (float)var3 + this.rand.nextFloat() * (var11.maxZ - var11.minZ - 0.2F) + 0.1F + var11.minZ;
			if(var4 == 0) {
				var7 = (float)var2 + var11.minY - 0.1F;
			}

			if(var4 == 1) {
				var7 = (float)var2 + var11.maxY + 0.1F;
			}

			if(var4 == 2) {
				var8 = (float)var3 + var11.minZ - 0.1F;
			}

			if(var4 == 3) {
				var8 = (float)var3 + var11.maxZ + 0.1F;
			}

			if(var4 == 4) {
				var6 = (float)var1 + var11.minX - 0.1F;
			}

			if(var4 == 5) {
				var6 = (float)var1 + var11.maxX + 0.1F;
			}

			EntityDiggingFX var10001 = new EntityDiggingFX(this.worldObj, var6, var7, var8, 0.0F, 0.0F, 0.0F, var11);
			float var9 = 0.2F;
			EntityDiggingFX var10 = var10001;
			var10.motionX *= (double)0.2F;
			var10.motionY = (var10.motionY - (double)0.1F) * (double)0.2F + (double)0.1F;
			var10.motionZ *= (double)0.2F;
			this.addEffect(var10.multipleParticleScaleBy(0.6F));
		}
	}
