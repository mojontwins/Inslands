...
public final class BlockChest extends BlockContainer {
		...
		if(i5 == 1) {
			...
			if(i6 != this.blockID && i7 != this.blockID) {
				if(i8 != this.blockID && i9 != this.blockID) {
					...
					i11 = world1.getBlockId(i8 == this.blockID ? i2 - 1 : i2 + 1, i3, i4 - 1);
					i12 = world1.getBlockId(i8 == this.blockID ? i2 - 1 : i2 + 1, i3, i4 + 1);
					if(i5 == 3) {
						i10 = -1 - i10;
					}
				...
				i11 = world1.getBlockId(i2 - 1, i3, i6 == this.blockID ? i4 - 1 : i4 + 1);
				i12 = world1.getBlockId(i2 + 1, i3, i6 == this.blockID ? i4 - 1 : i4 + 1);
				if(i5 == 4) {
					i10 = -1 - i10;
				}
	...
	public final boolean canPlaceBlockAt(World world1, int i2, int i3, int i4) {
		...
		return i5 > 1 ? false : (this.hasNeighborChest(world1, i2 - 1, i3, i4) ? false : (this.hasNeighborChest(world1, i2 + 1, i3, i4) ? false : (this.hasNeighborChest(world1, i2, i3, i4 - 1) ? false : !this.hasNeighborChest(world1, i2, i3, i4 + 1))));
	}

	private boolean hasNeighborChest(World world1, int i2, int i3, int i4) {
	...
	public final void onBlockRemoval(World world1, int i2, int i3, int i4) {
		...
		for(int i6 = 0; i6 < tileEntityChest5.getInventorySize(); ++i6) {
			...
			if((itemStack7 = tileEntityChest5.getStackInSlot(i6)) != null) {
				...
				while(itemStack7.stackSize > 0) {
					...
					(entityItem12 = new EntityItem(world1, (double)((float)i2 + f8), (double)((float)i3 + f9), (double)((float)i4 + f10), new ItemStack(itemStack7.itemID, i11, itemStack7.itemDamage))).motionX = (double)((float)this.random.nextGaussian() * 0.05F);
	...
	public final boolean blockActivated(World world1, int i2, int i3, int i4, EntityPlayer entityPlayer5) {
		...
		if(world1.isSolid(i2, i3 + 1, i4)) {
			return true;
		} else if(world1.getBlockId(i2 - 1, i3, i4) == this.blockID && world1.isSolid(i2 - 1, i3 + 1, i4)) {
			return true;
		} else if(world1.getBlockId(i2 + 1, i3, i4) == this.blockID && world1.isSolid(i2 + 1, i3 + 1, i4)) {
			return true;
		} else if(world1.getBlockId(i2, i3, i4 - 1) == this.blockID && world1.isSolid(i2, i3 + 1, i4 - 1)) {
			return true;
		} else if(world1.getBlockId(i2, i3, i4 + 1) == this.blockID && world1.isSolid(i2, i3 + 1, i4 + 1)) {
			return true;
		} else {
			...
			entityPlayer5.displayChestGUI((IInventory)object6);
			return true;
		}
	}
