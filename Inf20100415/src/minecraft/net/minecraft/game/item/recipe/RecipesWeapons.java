...
public final class RecipesWeapons {
	...
	private Object[][] recipeItems = new Object[][]{{Block.planks, Block.cobblestone, Item.ingotIron, Item.diamod, Item.ingotGold}, {Item.swordWood, Item.swordStone, Item.swordSteel, Item.swordDiamond, Item.swordGold}};

	public final void addRecipe(CraftingManager craftingManager1) {
		...
		craftingManager1.addRecipe(new ItemStack(Item.arrow, 4), new Object[]{"X", "#", "Y", 'Y', Item.feather, 'X', Item.ingotIron, '#', Item.stick});
	}
}