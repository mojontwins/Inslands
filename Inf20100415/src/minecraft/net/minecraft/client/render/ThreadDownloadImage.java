...
final class ThreadDownloadImage extends Thread {
	...
	ThreadDownloadImage(ThreadDownloadImageData threadDownloadImageData1, String string2, ImageBufferDownload imageBufferDownload3) {
		this.imageData = threadDownloadImageData1;
		this.location = string2;
		this.buffer = imageBufferDownload3;
	}
