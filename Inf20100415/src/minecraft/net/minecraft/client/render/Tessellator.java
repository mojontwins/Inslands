...
public final class Tessellator {
	...
	public final void addVertexWithUV(double d1, double d3, double d5, double d7, double d9) {
	...
	public final void addVertex(double d1, double d3, double d5) {
		++this.addedVertices;
		if(this.hasTexture) {
	...
	public final void setTranslationD(double d1, double d3, double d5) {
		this.xOffset = d1;
		this.yOffset = d3;
		this.zOffset = d5;
	}
