...
public final class GuiFurnace extends GuiContainer {
	...
	public GuiFurnace(InventoryPlayer inventoryPlayer1, TileEntityFurnace tileEntityFurnace2) {
		...
		this.inventorySlots.add(new Slot(this, tileEntityFurnace2, 0, 56, 17));
		this.inventorySlots.add(new Slot(this, tileEntityFurnace2, 1, 56, 53));
		this.inventorySlots.add(new Slot(this, tileEntityFurnace2, 2, 116, 35));

		int i4;
		for(i4 = 0; i4 < 3; ++i4) {
			for(int i3 = 0; i3 < 9; ++i3) {
				this.inventorySlots.add(new Slot(this, inventoryPlayer1, i3 + (i4 + 1) * 9, 8 + i3 * 18, 84 + i4 * 18));
			}
		}

		for(i4 = 0; i4 < 9; ++i4) {
			this.inventorySlots.add(new Slot(this, inventoryPlayer1, i4, 8 + i4 * 18, 142));
		}
