...
public abstract class GuiContainer extends GuiScreen {
	...
	public void drawScreen(int i1, int i2, float f3) {
		...
		if(this.itemStack != null) {
			...
			itemRenderer.renderItemIntoGUI(this.mc.renderEngine, this.itemStack, i1 - i13 - 8, i2 - i4 - 8);
			itemRenderer.renderItemOverlayIntoGUI(this.fontRenderer, this.itemStack, i1 - i13 - 8, i2 - i4 - 8);
		}
