...
final class SlotCrafting extends Slot {
	...
	public SlotCrafting(GuiContainer guiContainer1, IInventory iInventory2, IInventory iInventory3, int i4, int i5, int i6) {
	...
	public final void onPickupFromSlot() {
		for(int i1 = 0; i1 < this.craftMatrix.getInventorySize(); ++i1) {
