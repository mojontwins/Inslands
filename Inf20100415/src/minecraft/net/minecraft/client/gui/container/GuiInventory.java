...
public final class GuiInventory extends GuiContainer {
	...
	public GuiInventory(IInventory iInventory1) {
		...
		for(i2 = 0; i2 < 4; ++i2) {
			this.inventorySlots.add(new SlotArmor(this, this, iInventory1, iInventory1.getInventorySize() - 1 - i2, 8, 8 + i2 * 18, i2));
		}
	...
	public final void onGuiClosed() {
		...
		for(int i1 = 0; i1 < this.inventoryCrafting.getInventorySize(); ++i1) {
