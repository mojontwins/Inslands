...
public final class ModelSpider extends ModelBase {
	...
	public final void setRotationAngles(float f1, float f2, float f3, float f4, float f5, float f6) {
		...
		f3 = -(MathHelper.cos(f1 * 0.6662F * 2.0F) * 0.4F) * f2;
		f4 = -(MathHelper.cos(f1 * 0.6662F * 2.0F + (float)Math.PI) * 0.4F) * f2;
		f5 = -(MathHelper.cos(f1 * 0.6662F * 2.0F + (float)Math.PI / 2F) * 0.4F) * f2;
		f6 = -(MathHelper.cos(f1 * 0.6662F * 2.0F + 4.712389F) * 0.4F) * f2;
		float f7 = Math.abs(MathHelper.sin(f1 * 0.6662F) * 0.4F) * f2;
		float f8 = Math.abs(MathHelper.sin(f1 * 0.6662F + (float)Math.PI) * 0.4F) * f2;
		float f9 = Math.abs(MathHelper.sin(f1 * 0.6662F + (float)Math.PI / 2F) * 0.4F) * f2;
		f1 = Math.abs(MathHelper.sin(f1 * 0.6662F + 4.712389F) * 0.4F) * f2;
