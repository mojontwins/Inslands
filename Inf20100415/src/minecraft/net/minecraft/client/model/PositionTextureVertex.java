...
public final class PositionTextureVertex {
	...
	public PositionTextureVertex(float f1, float f2, float f3, float f4, float f5) {
		this(new Vec3D((double)f1, (double)f2, (double)f3), f4, f5);
	}
	...
	private PositionTextureVertex(PositionTextureVertex positionTextureVertex1, float f2, float f3) {
		this.vector3D = positionTextureVertex1.vector3D;
		this.texturePositionX = f2;
		this.texturePositionY = f3;
	}

	private PositionTextureVertex(Vec3D vec3D1, float f2, float f3) {
