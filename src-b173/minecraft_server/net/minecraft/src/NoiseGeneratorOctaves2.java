...
public class NoiseGeneratorOctaves2 extends NoiseGenerator {
	...
	public NoiseGeneratorOctaves2(Random random1, int i2) {
		this.numOctaves = i2;
		this.generatorCollection = new NoiseGenerator2[i2];

		for(int i3 = 0; i3 < i2; ++i3) {
			this.generatorCollection[i3] = new NoiseGenerator2(random1);
		}
	...
	public double[] generateNoiseOctaves(double[] d1, double d2, double d4, int i6, int i7, double d8, double d10, double d12, double d14) {
		...
		for(int i20 = 0; i20 < this.numOctaves; ++i20) {
			this.generatorCollection[i20].generateNoise(d1, d2, d4, i6, i7, d8 * d18, d10 * d18, 0.55D / d21);
			d18 *= d12;
			d21 *= d14;
		}
