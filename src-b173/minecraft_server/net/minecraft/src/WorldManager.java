...
public class WorldManager implements IWorldAccess {
	...
	public void obtainEntitySkin(Entity entity1) {
		this.mcServer.getEntityTracker(this.s_field_28134_b.worldProvider.worldType).trackEntity(entity1);
	}

	public void releaseEntitySkin(Entity entity1) {
		this.mcServer.getEntityTracker(this.s_field_28134_b.worldProvider.worldType).untrackEntity(entity1);
	}
	...
	public void markBlockNeedsUpdate(int i1, int i2, int i3) {
		this.mcServer.configManager.markBlockNeedsUpdate(i1, i2, i3, this.s_field_28134_b.worldProvider.worldType);
	}
	...
	public void playAuxSFX(EntityPlayer entityPlayer1, int i2, int i3, int i4, int i5, int i6) {
		this.mcServer.configManager.s_func_28171_a(entityPlayer1, (double)i3, (double)i4, (double)i5, 64.0D, this.s_field_28134_b.worldProvider.worldType, new Packet61DoorChange(i2, i3, i4, i5, i6));
	}
}
