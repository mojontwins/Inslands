...
public final class GuiIngame extends Gui {
	...
	public final void renderGameOverlay(float var1) {
		...
		this.mc.entityRenderer.startDrawingQuads();
		...
		if(this.mc.options.showFPS) {
			...
			var23 = this.mc;
			var4.drawStringWithShadow("P: " + var23.effectRenderer.getStatistics() + ". T: " + World.e(), 2, 32, 16777215);
		...
		for(var12 = 0; var12 < this.chatMessageList.size() && var12 < 10; ++var12) {
			if(((ThreadDownloadImageData)this.chatMessageList.get(var12)).updateCounter < 200) {
