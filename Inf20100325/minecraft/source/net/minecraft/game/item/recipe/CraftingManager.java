...
public final class CraftingManager {
	...
	private CraftingManager() {
		...
		new RecipesCrafting();
		this.addRecipe(new ItemStack(Block.waterSource), new Object[]{"###", "# #", "###", Character.valueOf('#'), Block.planks});
		this.addRecipe(new ItemStack(Block.stoneOvenIdle), new Object[]{"###", "# #", "###", Character.valueOf('#'), Block.cobblestone});
		this.addRecipe(new ItemStack(Block.oreDiamond), new Object[]{"##", "##", Character.valueOf('#'), Block.planks});
